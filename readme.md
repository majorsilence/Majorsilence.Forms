...
- [`Gallery.Gtk4`](samples/Gallery.Gtk4) — the control gallery running on the **GTK 4** backend (gir.core). Needs a desktop session and the GTK 4 native libraries; `MF_GTK4_DEMO=1` shows a small smoke form instead.
