...
namespace Modern.Forms.Tests
{
    ...
    // pinning the WinForms-compatible semantics that the Modern.Forms API exposes:
    ...
    // GetChildIndex/SetChildIndex reordering. These exercise the real Modern.Forms
