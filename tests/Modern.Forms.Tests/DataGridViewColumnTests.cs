...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms compat layer. Modern.Forms exposes most DataGridViewColumn members as simple
    // auto-properties (no element-state plumbing, accessibility, or design-time site), so these
    // pin the actual Modern.Forms semantics: constructor defaults, property get/set round-trips,
