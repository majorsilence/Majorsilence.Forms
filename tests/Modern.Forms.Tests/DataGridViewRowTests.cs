...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API (no Handle/CreateParams/accessibility/SharedRow/virtual-mode plumbing).
    // Modern.Forms' DataGridView is a compatibility layer, so these tests pin the behavior that is
