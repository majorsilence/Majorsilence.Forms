...
namespace Modern.Forms.Tests
{
    ...
    // TreeNodeCollectionTests, adapted to the Modern.Forms API (no Handle/CreateParams/
    // accessibility plumbing). Modern.Forms models nodes as TreeViewItem (with a TreeNode
    ...
    // Modern.Forms' actual, source-verified behavior against the WinForms semantics that do
    ...
    public class TreeViewTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // Modern.Forms keeps a hidden root selected by default; it is never null.
        ...
        {
            // Modern.Forms' TreeViewItem does not normalize null to "" in the ctor, so guard.
        ...
        public void SelectedItem_SetNull_IsIgnored ()
        {
            ...
            // Modern.Forms does not allow unselecting; the previous selection remains.
            Assert.Same (node, treeView.SelectedItem);
        }
