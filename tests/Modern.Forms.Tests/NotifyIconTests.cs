...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API. Modern.Forms has no native system-tray support, so tray/Handle/design-mode
    ...
    public class NotifyIconTests
    {
        ...
        {
            using var icon = new Modern.Drawing.Icon ((SkiaSharp.SKBitmap?)null);
        ...
        public void ShowBalloonTip_InvokeInt_Success (ToolTipIcon tipIcon)
        {
            ...
            // No-op in Modern.Forms (no tray), but must not throw with valid arguments.
