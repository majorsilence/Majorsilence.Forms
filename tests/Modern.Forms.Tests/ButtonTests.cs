...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API (no Handle/CreateParams/accessibility/ImeMode/Moq plumbing). They pin the
    ...
    //
    // Where Modern.Forms deliberately differs from WinForms (left-aligned text/image defaults,
    // null Text not coerced to string.Empty, no enum-argument validation) the tests assert
    // Modern.Forms' actual behavior; those divergences are described in the porting report.
    //
    ...
    public class ButtonTests
    {
        ...
        [Theory]
        // NOTE: WinForms coerces a null Text to string.Empty; Modern.Forms does not (the
        ...
        public void ToString_Invoke_ReturnsExpected ()
        {
            ...
            Assert.Equal ("Modern.Forms.Button, Text: ", control.ToString ());
        }
        ...
        public void ToString_InvokeShortText_ReturnsExpected ()
        {
            ...
            Assert.Equal ("Modern.Forms.Button, Text: Text", control.ToString ());
        }
    }
}
