...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API (no Handle/CreateParams/accessibility/Ime plumbing). They pin the
    ...
    public class PanelTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // attachment), Modern.Forms's Visible walks the parent chain (parent?.Visible ?? false), so
