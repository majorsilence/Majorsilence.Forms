...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API (no Handle/CreateParams/accessibility plumbing). Modern.Forms does NOT
    // enforce the mask; MaskedTextBox behaves as a plain TextBox with WinForms-compatible
    // property surface. These tests pin the ACTUAL Modern.Forms behavior (property round-trips,
    ...
    public class MaskedTextBoxTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // MaskCompleted/MaskFull are always-true stubs in Modern.Forms.
        ...
        {
            // Modern.Forms does not enforce the mask, so text is stored verbatim.
        ...
        public void Culture_Set_GetReturnsExpected ()
        {
            ...
            // Set null (Modern.Forms allows null; WinForms throws).
        ...
        {
            // Modern.Forms does not enforce the mask, so these stubs are always true
