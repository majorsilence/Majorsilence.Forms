...
namespace Modern.Forms.Tests
{
    ...
    // Modern.Forms API (no Handle/CreateParams/accessibility/ImeMode plumbing). They pin
    // the default property values plus the Text/TextChanged, FlatStyle, AutoSize,
    // UseCompatibleTextRendering and TabStop semantics against the real Modern.Forms surface.
