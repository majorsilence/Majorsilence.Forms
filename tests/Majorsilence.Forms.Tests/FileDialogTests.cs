...
namespace Majorsilence.Forms.Tests
{
    ...
    // tests, adapted to the Majorsilence.Forms API. Majorsilence.Forms exposes the dialogs as a plain object
    ...
    public class FileDialogTests
    {
        ...
        {
            // Majorsilence.Forms stores DefaultExt verbatim (no leading-dot normalization).
