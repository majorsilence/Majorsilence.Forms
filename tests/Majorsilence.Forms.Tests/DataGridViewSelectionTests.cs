...
namespace Majorsilence.Forms.Tests
{
    ...
    public class DataGridViewSelectionTests
    {
        ...
        public void A_selected_row_is_painted_highlighted ()
        {
            ...
            try {
                var highlight = Theme.ControlHighlightLowColor;
        ...
        public void In_cell_mode_a_selected_cell_is_outlined_and_its_row_is_not_highlighted ()
        {
            ...
            try {
                ...
                Assert.True (CountIn (bitmap, grid.GetCellBounds (1, 1), Theme.AccentColor) > 0,
                    "the selected cell was not outlined");
                Assert.True (Coverage (bitmap, grid.GetCellBounds (1, 0), Theme.ControlHighlightLowColor) < Unfilled,
