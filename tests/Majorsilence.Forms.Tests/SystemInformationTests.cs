...
namespace Majorsilence.Forms.Tests
{
    ...
    // Majorsilence.Forms API. SystemInformation in Majorsilence.Forms is a cross-platform stub provider: most
    ...
    public class SystemInformationTests
    {
        ...
        {
            // Upstream asserts width > 0; Majorsilence.Forms pins it to a fixed value.
        ...
        {
            // Majorsilence.Forms exposes this as a single int (not a Size, unlike WinForms).
