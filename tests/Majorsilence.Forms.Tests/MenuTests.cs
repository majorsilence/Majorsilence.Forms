...
// rewritten for the Majorsilence.Forms menu API. Original work Copyright (c) .NET Foundation and Contributors.
...
namespace Majorsilence.Forms.Tests
{
    ...
    // but written strictly against the Majorsilence.Forms menu family (MenuItem, Menu, MenuDropDown,
    // ContextMenu, MenuItemCollection, MenuSeparatorItem). Majorsilence.Forms uses its own menu types rather
    // than ToolStripMenuItem/ContextMenuStrip, so these pin Majorsilence.Forms' actual ctor/property/collection
