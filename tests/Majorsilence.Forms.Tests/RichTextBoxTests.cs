...
namespace Majorsilence.Forms.Tests
{
    ...
    // Majorsilence.Forms API (no Handle/CreateParams/accessibility plumbing, and no real RTF rendering
    // engine). Majorsilence.Forms' RichTextBox is a thin subclass of TextBox: most rich-text members are
    ...
    public class RichTextBoxTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // WinForms RichTextBox defaults that Majorsilence.Forms matches.
        ...
        // Majorsilence.Forms strips RTF markup down to plain text (it has no RTF renderer). Verify the
