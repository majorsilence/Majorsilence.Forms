...
namespace Majorsilence.Forms.Tests
{
    ...
    // the Majorsilence.Forms compat API (DataGridViewCellStyle lives in DataGridViewCompat.cs). They pin
    ...
    // omitted because the Majorsilence.Forms compat layer does not implement them.
