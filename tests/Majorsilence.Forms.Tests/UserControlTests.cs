...
namespace Majorsilence.Forms.Tests
{
    ...
    // Majorsilence.Forms API (no Handle/CreateParams/accessibility/ImeMode/Site/Moq plumbing). They
    // pin the property get/set semantics (Text, AutoSize, AutoSizeMode, BorderStyle, AutoValidate),
    // container behavior, and the Load event. Where Majorsilence.Forms intentionally diverges from
    // WinForms (e.g. DefaultSize, default AutoScaleMode), the assertions follow the Majorsilence.Forms
