...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility/ImeMode plumbing, no SubSplitter
    ...
    // Continuum.Forms-specific behavior (the Orientation property, the Drag event) is also covered.
    public class SplitterTests
    {
        ...
        {
            // SplitterMoved is a no-op stub in Continuum.Forms; subscribing/unsubscribing must be safe.
            using var control = new Splitter ();
        ...
        {
            // SplitterMoving is a no-op stub in Continuum.Forms; subscribing/unsubscribing must be safe.
            using var control = new Splitter ();
