...
// rewritten for the Continuum.Forms menu API. Original work Copyright (c) .NET Foundation and Contributors.
...
namespace Continuum.Forms.Tests
{
    ...
    // but written strictly against the Continuum.Forms menu family (MenuItem, Menu, MenuDropDown,
    // ContextMenu, MenuItemCollection, MenuSeparatorItem). Continuum.Forms uses its own menu types rather
    // than ToolStripMenuItem/ContextMenuStrip, so these pin Continuum.Forms' actual ctor/property/collection
