...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility/Ime plumbing). They pin the
    ...
    public class PanelTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // attachment), Continuum.Forms's Visible walks the parent chain (parent?.Visible ?? false), so
