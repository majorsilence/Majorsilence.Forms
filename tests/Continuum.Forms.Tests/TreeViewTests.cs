...
namespace Continuum.Forms.Tests
{
    ...
    // TreeNodeCollectionTests, adapted to the Continuum.Forms API (no Handle/CreateParams/
    // accessibility plumbing). Continuum.Forms models nodes as TreeViewItem (with a TreeNode
    ...
    // Continuum.Forms' actual, source-verified behavior against the WinForms semantics that do
    ...
    public class TreeViewTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // Continuum.Forms keeps a hidden root selected by default; it is never null.
        ...
        {
            // Continuum.Forms' TreeViewItem does not normalize null to "" in the ctor, so guard.
        ...
        public void SelectedItem_SetNull_IsIgnored ()
        {
            ...
            // Continuum.Forms does not allow unselecting; the previous selection remains.
            Assert.Same (node, treeView.SelectedItem);
        }
