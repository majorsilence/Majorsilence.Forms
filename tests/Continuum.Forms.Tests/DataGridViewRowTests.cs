...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility/SharedRow/virtual-mode plumbing).
    // Continuum.Forms' DataGridView is a compatibility layer, so these tests pin the behavior that is
