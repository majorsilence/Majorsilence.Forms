...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility plumbing). Continuum.Forms does NOT
    // enforce the mask; MaskedTextBox behaves as a plain TextBox with WinForms-compatible
    // property surface. These tests pin the ACTUAL Continuum.Forms behavior (property round-trips,
    ...
    public class MaskedTextBoxTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // MaskCompleted/MaskFull are always-true stubs in Continuum.Forms.
        ...
        {
            // Continuum.Forms does not enforce the mask, so text is stored verbatim.
        ...
        public void Culture_Set_GetReturnsExpected ()
        {
            ...
            // Set null (Continuum.Forms allows null; WinForms throws).
        ...
        {
            // Continuum.Forms does not enforce the mask, so these stubs are always true
