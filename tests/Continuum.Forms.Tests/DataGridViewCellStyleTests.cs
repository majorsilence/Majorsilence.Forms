...
namespace Continuum.Forms.Tests
{
    ...
    // the Continuum.Forms compat API (DataGridViewCellStyle lives in DataGridViewCompat.cs). They pin
    ...
    // omitted because the Continuum.Forms compat layer does not implement them.
