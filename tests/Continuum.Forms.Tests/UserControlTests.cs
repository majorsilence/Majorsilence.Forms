...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility/ImeMode/Site/Moq plumbing). They
    // pin the property get/set semantics (Text, AutoSize, AutoSizeMode, BorderStyle, AutoValidate),
    // container behavior, and the Load event. Where Continuum.Forms intentionally diverges from
    // WinForms (e.g. DefaultSize, default AutoScaleMode), the assertions follow the Continuum.Forms
