...
namespace Continuum.Forms.Tests
{
    ...
    // Continuum.Forms API (no Handle/CreateParams/accessibility plumbing, and no real RTF rendering
    // engine). Continuum.Forms' RichTextBox is a thin subclass of TextBox: most rich-text members are
    ...
    public class RichTextBoxTests
    {
        ...
        public void Ctor_Default ()
        {
            ...
            // WinForms RichTextBox defaults that Continuum.Forms matches.
        ...
        // Continuum.Forms strips RTF markup down to plain text (it has no RTF renderer). Verify the
