...
namespace Continuum.Forms.Tests
{
    ...
    // the Continuum.Forms API (no Handle / CreateParams / accessibility plumbing). Continuum.Forms has no
    ...
    public class TabControlTests
    {
        ...
        {
            // Continuum.Forms has no deferred-handle model: it validates the index eagerly against the
