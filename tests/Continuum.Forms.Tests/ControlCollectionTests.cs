...
namespace Continuum.Forms.Tests
{
    ...
    // pinning the WinForms-compatible semantics that the Continuum.Forms API exposes:
    ...
    // GetChildIndex/SetChildIndex reordering. These exercise the real Continuum.Forms
