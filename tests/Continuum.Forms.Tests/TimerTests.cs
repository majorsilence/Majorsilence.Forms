...
{
    // Behavioral tests ported from the upstream WinForms TimerTests, adapted to the Continuum.Forms
    ...
    public class TimerTests
    {
        ...
        {
            using var timer = new Timer ();
            Assert.Equal ("Continuum.Forms.Timer, Interval: 100", timer.ToString ());
        }
    }
}
