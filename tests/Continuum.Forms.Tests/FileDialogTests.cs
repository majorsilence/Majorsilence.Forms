...
// src/test/unit/System.Windows.Forms/System/Windows/Forms/), rewritten for the Continuum.Forms API.
...
namespace Continuum.Forms.Tests
{
    ...
    // tests, adapted to the Continuum.Forms API. Continuum.Forms exposes the dialogs as a plain object
    ...
    public class FileDialogTests
    {
        ...
        {
            // Continuum.Forms stores DefaultExt verbatim (no leading-dot normalization).
        ...
        {
            // Continuum.Forms resolves FileName through Path.GetFullPath, so the getter returns
