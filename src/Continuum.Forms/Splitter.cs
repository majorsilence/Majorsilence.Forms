...
namespace Continuum.Forms
{
    ...
    public class Splitter : Control
    {
        ...
        /// <summary>Gets or sets the current position of the splitter. Alias for SplitterWidth. Stub in Continuum.Forms.</summary>
        public int SplitPosition { get => SplitterWidth; set => SplitterWidth = value; }

        /// <summary>Gets or sets the minimum size of the first panel. Negative values are coerced to 0. Stub in Continuum.Forms.</summary>
        public int MinSize {
            get => min_size;
            set => min_size = Math.Max (0, value);
        }

        /// <summary>Gets or sets the minimum remaining space after the splitter. Negative values are coerced to 0. Stub in Continuum.Forms.</summary>
        public int MinExtra {
            get => min_extra;
