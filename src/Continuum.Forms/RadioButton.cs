...
#pragma warning restore CA1416
        ...
        /// <summary>Gets or sets the appearance of the RadioButton. Stub in Continuum.Forms.</summary>
        public Appearance Appearance { get; set; } = Appearance.Normal;

        /// <summary>Gets or sets the flat style appearance of the radio button. Stub in Continuum.Forms.</summary>
