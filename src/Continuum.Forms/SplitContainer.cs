...
namespace Continuum.Forms
{
    ...
    public class SplitContainer : Control
    {
        ...
        /// <summary>Gets or sets whether the splitter is fixed. Stub in Continuum.Forms.</summary>
        public FixedPanel FixedPanel { get; set; } = FixedPanel.None;

        /// <summary>Gets or sets whether Panel1 is collapsed. Stub in Continuum.Forms.</summary>
        public bool Panel1Collapsed {
            get => !Panel1.Visible;
            set => Panel1.Visible = !value;
        }

        /// <summary>Gets or sets whether Panel2 is collapsed. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the minimum size (in pixels) of Panel1. Stub in Continuum.Forms.</summary>
        public int Panel1MinSize { get; set; } = 25;

        /// <summary>Gets or sets the minimum size (in pixels) of Panel2. Stub in Continuum.Forms.</summary>
        public int Panel2MinSize { get; set; } = 25;

        /// <summary>Gets or sets the number of pixels the splitter moves when incremented via keyboard. Stub in Continuum.Forms.</summary>
        public int SplitterIncrement { get; set; } = 1;

        /// <summary>Raised when the splitter is moved. Stub in Continuum.Forms.</summary>
        public event EventHandler<SplitterEventArgs>? SplitterMoved { add { } remove { } }

        /// <summary>Raised while the splitter is being moved. Stub in Continuum.Forms.</summary>
