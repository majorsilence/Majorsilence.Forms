...
namespace Continuum.Forms
{
    ...
    {
        private Continuum.Drawing.Image? background_image;
        ...
        /// <summary>
        /// Gets or sets a value indicating the control is double-buffered. Continuum.Forms always renders
        ...
        /// Accepts <see cref="Continuum.Drawing.Image"/> for WinForms compatibility.
        /// </summary>
        public Continuum.Drawing.Image? BackgroundImage {
...
#pragma warning restore CA1416
        ...
        /// <summary>Waits for a pending asynchronous call to complete. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Always returns true in Continuum.Forms — the control is always created.</summary>
        public bool IsHandleCreated => true;

        /// <summary>Always returns false in Continuum.Forms — right-to-left mirroring is not supported.</summary>
        public bool IsMirrored => false;

        /// <summary>Returns a platform handle (always IntPtr.Zero in Continuum.Forms).</summary>
        public IntPtr Handle => IntPtr.Zero;

        /// <summary>Forces the creation of the control handle. Stub in Continuum.Forms — handle is always ready.</summary>
        public void CreateHandle () { }

        /// <summary>Applies updated ControlStyles flags. Stub in Continuum.Forms — styles are applied immediately.</summary>
        ...
        /// <summary>Gets or sets the accessible name of the control. Stub in Continuum.Forms.</summary>
        public string? AccessibleName { get; set; }

        /// <summary>Gets or sets the default action description for the control's accessibility object. Stub in Continuum.Forms.</summary>
        public string? AccessibleDefaultActionDescription { get; set; }

        /// <summary>Gets or sets the accessible description of the control. Stub in Continuum.Forms.</summary>
        public string? AccessibleDescription { get; set; }

        /// <summary>Gets or sets whether the control accepts drag-and-drop data. Stub in Continuum.Forms.</summary>
        public bool AllowDrop { get; set; }

        /// <summary>Causes all validation in the control hierarchy to occur. Always returns true in Continuum.Forms.</summary>
        public bool Validate () => true;

        /// <summary>Causes all validation in the control hierarchy to occur. Always returns true in Continuum.Forms.</summary>
        public bool Validate (bool checkAutoValidate) => true;

        /// <summary>Gets or sets whether user input in the control causes validation to occur. Stub in Continuum.Forms.</summary>
        public bool CausesValidation { get; set; } = true;

        /// <summary>Gets or sets the Input Method Editor (IME) mode. Stub in Continuum.Forms.</summary>
        public ImeMode ImeMode { get; set; } = ImeMode.NoControl;

        /// <summary>Begins a drag-and-drop operation. Stub in Continuum.Forms — always returns None.</summary>
        ...
        /// <summary>Scales the control by the specified horizontal and vertical scaling factors. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the data bindings for this control. Stub in Continuum.Forms — bindings are not evaluated.</summary>
        public ControlBindingsCollection DataBindings => _dataBindings ??= new ControlBindingsCollection (this);

        /// <summary>Gets or sets the binding context for this control. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>
        /// Processes Windows messages. Override to intercept messages. Stub in Continuum.Forms — does nothing.
        /// </summary>
        protected virtual void WndProc (ref Message m) { }

        /// <summary>
        /// Invokes the default Windows procedure for the control. Stub in Continuum.Forms — does nothing.
        /// </summary>
        protected void DefWndProc (ref Message m) { }

        /// <summary>Gets the creation parameters for the control. Returns a stub in Continuum.Forms.</summary>
        protected virtual CreateParams CreateParams => new CreateParams ();

        /// <summary>
        /// Renders the control and its children to a Continuum.Drawing.Bitmap.
        /// Stub in Continuum.Forms — creates an empty bitmap of the control's size.
        /// </summary>
#pragma warning disable CA1416
        public void DrawToBitmap (Continuum.Drawing.Bitmap bitmap, Rectangle targetBounds)
        {
        }
#pragma warning restore CA1416
        ...
        /// Override to accept additional keys. Continuum.Forms stub — returns false.
        /// </summary>
        protected virtual bool IsInputKey (Keys keyData) => false;

        /// <summary>
        /// Determines whether a character is an input character. Continuum.Forms stub — returns false.
        /// </summary>
        ...
        /// Returns true if the key was processed. Continuum.Forms stub — passes through to the base implementation.
        /// </summary>
        ...
        /// Returns true if the key was handled. Continuum.Forms stub.
        /// </summary>
        protected virtual bool ProcessDialogKey (Keys keyData) => false;

        /// <summary>Processes a keyboard message. Returns true if the message was handled. Stub in Continuum.Forms.</summary>
        protected virtual bool ProcessKeyMessage (ref Message m) => false;

        /// <summary>
        /// Previews a keyboard message. Returns true if the message was handled. Continuum.Forms stub.
        /// </summary>
        protected virtual bool ProcessKeyPreview (ref Message m) => false;

        /// <summary>
        /// Performs the mnemonic operation (Alt+key) for the control. Returns true if handled. Continuum.Forms stub.
        /// </summary>
        protected virtual bool ProcessMnemonic (char charCode) => false;

        /// <summary>Gets whether the control's Size includes scrollbar sizes. Stub in Continuum.Forms.</summary>
        public bool HScroll { get; set; }

        /// <summary>Gets whether the control's Size includes scrollbar sizes. Stub in Continuum.Forms.</summary>
        public bool VScroll { get; set; }

        /// <summary>Processes a tab key. Returns true if the key was processed. Continuum.Forms stub.</summary>
        protected virtual bool ProcessTabKey (bool forward) => false;

        /// <summary>Notifies the accessibility client application of a specified event. Stub in Continuum.Forms.</summary>
        public void AccessibilityNotifyClients (AccessibleEvents accEvent, int childID) { }

        /// <summary>Gets or sets the window region associated with the control. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Region? Region { get; set; }

        /// <summary>Gets whether this control is currently in design mode. Always false in Continuum.Forms.</summary>
        public new bool DesignMode => false;

        /// <summary>Gets the site associated with this component. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Extension methods for converting <see cref="Continuum.Drawing.Image"/> to SkiaSharp bitmaps. Fully cross-platform (Skia-backed, no GDI+).</summary>
    public static class BitmapCompatExtensions
    {
        /// <summary>Returns a copy of the SkiaSharp bitmap backing the given <see cref="Continuum.Drawing.Bitmap"/>.</summary>
        public static SkiaSharp.SKBitmap? ToSKBitmap (this Continuum.Drawing.Bitmap bitmap)
            => bitmap?.GetSKBitmap ()?.Copy ();

        /// <summary>Returns a copy of the SkiaSharp bitmap backing the given <see cref="Continuum.Drawing.Image"/>.</summary>
        public static SkiaSharp.SKBitmap? ToSKBitmap (this Continuum.Drawing.Image image)
