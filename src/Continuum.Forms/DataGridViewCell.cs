...
namespace Continuum.Forms
{
    ...
    public class DataGridViewCell
    {
        ...
        /// <summary>Gets or sets the error message text for this cell. Stub in Continuum.Forms.</summary>
        public string ErrorText { get; set; } = string.Empty;

        /// <summary>Gets or sets whether this cell is visible. Stub in Continuum.Forms.</summary>
