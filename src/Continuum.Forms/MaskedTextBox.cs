namespace Continuum.Forms
{
    ...
    /// In Continuum.Forms, the mask is not enforced; this behaves as a plain TextBox.
    /// </summary>
    public class MaskedTextBox : TextBox
    {
        private string _mask = string.Empty;

        /// <summary>Gets or sets the input mask string. Not enforced in Continuum.Forms.</summary>
        public string Mask {
            get => _mask;
            set => _mask = value ?? string.Empty;
        }

        /// <summary>Gets or sets the character used for prompting for required input. Not enforced in Continuum.Forms.</summary>
        public char PromptChar { get; set; } = '_';

        /// <summary>Gets or sets whether the mask is used to filter input. Stub in Continuum.Forms.</summary>
        public new bool UseSystemPasswordChar { get; set; }

        /// <summary>Gets or sets whether the prompt characters are included in the text. Stub in Continuum.Forms.</summary>
        public bool HidePromptOnLeave { get; set; }

        /// <summary>Gets whether the text currently satisfies the mask. Always returns true in Continuum.Forms.</summary>
        public bool MaskCompleted => true;

        /// <summary>Gets whether all required positions in the mask are satisfied. Always returns true in Continuum.Forms.</summary>
        public bool MaskFull => true;

        /// <summary>Gets or sets whether to cut/copy the mask along with the text. Stub in Continuum.Forms.</summary>
        public bool CutCopyMaskFormat { get; set; }

        /// <summary>Gets or sets the culture used for separator characters. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the text mask format used for cut and copy operations. Stub in Continuum.Forms.</summary>
        public MaskFormat TextMaskFormat { get; set; } = MaskFormat.IncludeLiterals;

        /// <summary>Gets or sets whether only ASCII characters are accepted. Stub in Continuum.Forms.</summary>
        public bool AsciiOnly { get; set; }

        /// <summary>Gets or sets whether a beep occurs when invalid input is detected. Stub in Continuum.Forms.</summary>
        public bool BeepOnError { get; set; }

        /// <summary>Raised when user input is rejected by the mask. Stub in Continuum.Forms.</summary>
        public event EventHandler<MaskInputRejectedEventArgs>? MaskInputRejected { add { } remove { } }

        /// <summary>Raised when type validation completes. Stub in Continuum.Forms.</summary>
