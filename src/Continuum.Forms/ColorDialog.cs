...
namespace Continuum.Forms
{
    ...
    public class ColorDialog : Form
    {
        ...
        /// <summary>Gets or sets whether the user is restricted to selecting solid colors only. Stub in Continuum.Forms.</summary>
        public bool SolidColorOnly { get; set; }

        /// <summary>Gets or sets whether the Help button is displayed. Stub in Continuum.Forms.</summary>
