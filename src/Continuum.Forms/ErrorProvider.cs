...
namespace Continuum.Forms
{
    ...
    /// Continuum.Forms does not render error icons natively; the error text is stored for
    ...
    public class ErrorProvider : Component
    {
        ...
        /// <summary>
        /// Gets or sets the rate in milliseconds at which the error icon blinks. Stub in Continuum.Forms.
        ...
        /// <summary>Gets or sets the blink style for the error icon. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the container control (form) to watch. Stub in Continuum.Forms.</summary>
        public Form? ContainerControl { get; set; }

        /// <summary>Gets or sets the icon displayed next to a control with an error. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Icon? Icon { get; set; }
        ...
        /// <summary>Sets the icon alignment for the specified control. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the icon alignment for the specified control. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Sets the icon padding for the specified control. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the icon padding for the specified control. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the data source for automatic validation. Stub in Continuum.Forms.</summary>
        public object? DataSource { get; set; }

        /// <summary>Gets or sets the data member for automatic validation. Stub in Continuum.Forms.</summary>
