...
namespace Continuum.Forms
{
    ...
    public class Form : WindowBase, IWin32Window
    {
        ...
        public Form ()
        {
            InitWindow (Continuum.Forms.Backends.Platform.Backend.CreateWindow (this, isPopup: false));
        ...
        /// <summary>Raised when the user begins to resize the form. Stub in Continuum.Forms.</summary>
        public event EventHandler? ResizeBegin { add { } remove { } }

        /// <summary>Raised when the user finishes resizing the form. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Raised when an MDI child form is activated. Stub in Continuum.Forms.</summary>
        public event EventHandler? MdiChildActivate { add { } remove { } }

        /// <summary>Raised when the DPI setting for the form changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? DpiChanged { add { } remove { } }

        /// <summary>Raised when the input language changes. Stub in Continuum.Forms.</summary>
        public event EventHandler<InputLanguageChangedEventArgs>? InputLanguageChanged { add { } remove { } }

        /// <summary>Raised when the input language is changing. Stub in Continuum.Forms.</summary>
        ...
        private Continuum.Drawing.Icon? _formIcon;

        /// <summary>
        /// Gets or sets the icon for the form. Accepts <see cref="Continuum.Drawing.Icon"/> for WinForms compatibility.
        /// </summary>
#pragma warning disable CA1416
        public Continuum.Drawing.Icon? Icon {
            get => _formIcon;
            set {
                _formIcon = value;
                if (value is null)
...
#pragma warning restore CA1416
        ...
        /// <summary>Shows the form, ignoring the owner parameter (Continuum.Forms has no Win32 parenting).</summary>
        public void Show (IWin32Window owner) => Show ();

        /// <summary>Implements IWin32Window: returns IntPtr.Zero (Continuum.Forms has no Win32 handle).</summary>
        ...
        /// <summary>Gets or sets the client area size (equivalent to Size for Continuum.Forms).</summary>
        public System.Drawing.Size ClientSize {
            get => Size;
            set => Size = value;
        }

        /// <summary>Gets or sets the automatic scaling mode. No-op in Continuum.Forms.</summary>
        public AutoScaleMode AutoScaleMode { get; set; } = AutoScaleMode.Font;

        /// <summary>Gets or sets the auto-scale dimensions. No-op in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the binding context. No-op in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the color treated as transparent. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the form is an MDI container. Stub — MDI is not supported in Continuum.Forms.</summary>
        public bool IsMdiContainer { get; set; }

        /// <summary>Gets the MDI parent form. Always null in Continuum.Forms.</summary>
        public Form? MdiParent { get; set; }

        /// <summary>Gets the MDI child forms. Always empty in Continuum.Forms.</summary>
        public Form[] MdiChildren => [];

        /// <summary>Gets whether this form is a child of an MDI container. Always false in Continuum.Forms.</summary>
        public bool IsMdiChild => false;

        /// <summary>Gets the active MDI child form. Always null in Continuum.Forms.</summary>
        public Form? ActiveMdiChild => null;

        /// <summary>Activates the specified MDI child form. Stub in Continuum.Forms.</summary>
        public void ActivateMdiChild (Form? form) { }

        /// <summary>Arranges the MDI child forms. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Activates the form and gives it focus. No-op stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the help button visibility in the title bar. Stub in Continuum.Forms.</summary>
        public bool HelpButton { get; set; }

        /// <summary>Gets or sets whether to display the icon in the title bar. Stub in Continuum.Forms.</summary>
        public bool ShowIcon { get; set; } = true;

        /// <summary>Raises the Load event on next show. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the description of the form as an accessible object. Stub in Continuum.Forms.</summary>
        public string? AccessibleDescription { get; set; }

        /// <summary>Gets or sets the name of the form as an accessible object. Stub in Continuum.Forms.</summary>
