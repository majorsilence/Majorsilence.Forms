...
namespace Continuum.Forms
{
    ...
    public static class Clipboard
    {
        ...
        /// <summary>Returns whether the clipboard contains an image. Stub in Continuum.Forms — always returns false.</summary>
        public static bool ContainsImage () => false;

        /// <summary>Returns the image on the clipboard, or null. Stub in Continuum.Forms — always returns null.</summary>
        public static Continuum.Drawing.Image? GetImage () => null;

        /// <summary>Places an image on the clipboard. Stub in Continuum.Forms — no-op.</summary>
        public static void SetImage (Continuum.Drawing.Image image) { }
    ...
    /// <summary>Implements <see cref="IDataObject"/> for transferring data. Stub in Continuum.Forms.</summary>
