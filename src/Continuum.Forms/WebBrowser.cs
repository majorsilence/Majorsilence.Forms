namespace Continuum.Forms
{
    ...
    /// Continuum.Forms does not provide a real browser engine — this stub allows code to compile.
    /// </summary>
    public class WebBrowser : Control
    {
        ...
        /// <summary>Gets the title of the current document. Stub in Continuum.Forms.</summary>
        public string DocumentTitle => string.Empty;

        /// <summary>Gets or sets whether the browser can navigate backward. Stub in Continuum.Forms.</summary>
        public bool CanGoBack => false;

        /// <summary>Gets or sets whether the browser can navigate forward. Stub in Continuum.Forms.</summary>
        public bool CanGoForward => false;

        /// <summary>Gets the ready state of the browser. Stub in Continuum.Forms.</summary>
        public WebBrowserReadyState ReadyState => WebBrowserReadyState.Complete;

        /// <summary>Gets or sets whether script errors are suppressed. Stub in Continuum.Forms.</summary>
        public bool ScriptErrorsSuppressed { get; set; } = true;

        /// <summary>Gets or sets whether scroll bars are visible. Stub in Continuum.Forms.</summary>
        public bool ScrollBarsEnabled { get; set; } = true;

        /// <summary>Gets or sets whether the context menu is allowed. Stub in Continuum.Forms.</summary>
        public bool IsWebBrowserContextMenuEnabled { get; set; } = true;

        /// <summary>Gets or sets whether the keyboard shortcuts for the browser are enabled. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Navigates backward in the history. Stub in Continuum.Forms.</summary>
        public void GoBack () { }

        /// <summary>Navigates forward in the history. Stub in Continuum.Forms.</summary>
        public void GoForward () { }

        /// <summary>Navigates to the home page. Stub in Continuum.Forms.</summary>
        public void GoHome () { }

        /// <summary>Stops the current navigation. Stub in Continuum.Forms.</summary>
        public new void Stop () { }

        /// <summary>Prints the current document. Stub in Continuum.Forms.</summary>
        public void Print () { }

        /// <summary>Prints the current document with a dialog. Stub in Continuum.Forms.</summary>
        public void ShowPrintDialog () { }

        /// <summary>Invokes a script function. Stub in Continuum.Forms — returns null.</summary>
        public object? InvokeScript (string scriptName) => null;

        /// <summary>Invokes a script function with arguments. Stub in Continuum.Forms — returns null.</summary>
        public object? InvokeScript (string scriptName, object[] args) => null;

        /// <summary>Raised when the document has finished loading. Stub in Continuum.Forms.</summary>
        public event EventHandler<WebBrowserDocumentCompletedEventArgs>? DocumentCompleted { add { } remove { } }

        /// <summary>Raised when a navigation has completed. Stub in Continuum.Forms.</summary>
        public event EventHandler<WebBrowserNavigatedEventArgs>? Navigated { add { } remove { } }

        /// <summary>Raised before a navigation starts. Stub in Continuum.Forms.</summary>
        public event EventHandler<WebBrowserNavigatingEventArgs>? Navigating { add { } remove { } }

        /// <summary>Raised when the CanGoBack or CanGoForward property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? CanGoBackChanged { add { } remove { } }

        /// <summary>Raised when the CanGoForward property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? CanGoForwardChanged { add { } remove { } }

        /// <summary>Raised when the DocumentTitle property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? DocumentTitleChanged { add { } remove { } }

        /// <summary>Raised when the StatusText property changes. Stub in Continuum.Forms.</summary>
