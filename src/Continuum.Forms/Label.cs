...
#pragma warning restore CA1416
        ...
        /// <summary>Gets or sets the border style for the label. Stub in Continuum.Forms (does not render borders).</summary>
        public BorderStyle BorderStyle { get; set; } = BorderStyle.None;

        /// <summary>Gets or sets the flat style for the label. Stub in Continuum.Forms.</summary>
