...
namespace Continuum.Forms
{
    ...
    public class DataGridView : Control, System.ComponentModel.ISupportInitialize
    {
        ...
        /// <summary>
        /// Begins editing the currently selected cell (WinForms compat overload). Stub in Continuum.Forms.
        /// </summary>
        ...
        /// <summary>Raised when the state of a cell changes. Stub in Continuum.Forms.</summary>
        public event EventHandler<DataGridViewCellStateChangedEventArgs>? CellStateChanged { add { } remove { } }

        /// <summary>Raised when a cell enters editing mode and the editing control is about to be shown. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Raised when a new row is needed (virtual mode). Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Raised to allow custom sorting comparison. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets how row heights are automatically adjusted. Stub in Continuum.Forms.</summary>
        public DataGridViewAutoSizeRowsMode AutoSizeRowsMode { get; set; } = DataGridViewAutoSizeRowsMode.None;

        /// <summary>Gets or sets what is copied to the clipboard. Stub in Continuum.Forms.</summary>
        ...
        /// Continuum.Forms stub — column creation from DataSource is not automatically generated.
        /// </summary>
        ...
        /// <summary>Gets or sets the data member within the data source. Stub in Continuum.Forms.</summary>
        public string DataMember { get; set; } = string.Empty;

        /// <summary>Gets or sets the cell border style. Stub in Continuum.Forms.</summary>
        public DataGridViewCellBorderStyle CellBorderStyle { get; set; } = DataGridViewCellBorderStyle.Single;

        /// <summary>Gets or sets whether users can add new rows. Stub in Continuum.Forms.</summary>
        public bool AllowUserToAddRows { get; set; } = true;

        /// <summary>Gets or sets whether users can delete rows. Stub in Continuum.Forms.</summary>
        public bool AllowUserToDeleteRows { get; set; } = true;

        /// <summary>Gets or sets whether users can order columns. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the background color of the DataGridView. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color BackgroundColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the color of the grid lines. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color GridColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the edit mode of the DataGridView. Stub in Continuum.Forms.</summary>
        public DataGridViewEditMode EditMode { get; set; } = DataGridViewEditMode.EditOnKeystrokeOrF2;

        /// <summary>Gets or sets the size mode for the row header width. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the tab key behavior in the DataGridView. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Commits any pending edit for the specified context. Delegates to EndEdit in Continuum.Forms.</summary>
        ...
        /// <summary>Gets a row that serves as a template for new rows. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the column used for row headers. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Adjusts the width of all columns to fit their contents. Stub in Continuum.Forms.</summary>
        public void AutoResizeColumns () => Invalidate ();

        /// <summary>Adjusts the width of all columns using the specified sizing mode. Stub in Continuum.Forms.</summary>
        public void AutoResizeColumns (DataGridViewAutoSizeColumnsMode autoSizeColumnsMode) => Invalidate ();

        /// <summary>Adjusts the width of the specified column to fit its contents. Stub in Continuum.Forms.</summary>
        public void AutoResizeColumn (int columnIndex) => Invalidate ();

        /// <summary>Adjusts the width of the specified column using the specified sizing mode. Stub in Continuum.Forms.</summary>
        public void AutoResizeColumn (int columnIndex, DataGridViewAutoSizeColumnMode autoSizeColumnMode) => Invalidate ();

        /// <summary>Adjusts the height of all rows to fit their contents. Stub in Continuum.Forms.</summary>
        public void AutoResizeRows () => Invalidate ();

        /// <summary>Adjusts the height of all rows using the specified sizing mode. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Notifies the DataGridView that the current cell value has changed. Stub in Continuum.Forms.</summary>
        public void NotifyCurrentCellDirty (bool dirty) { }

        /// <summary>Updates the value displayed in the specified cell. Invalidates the cell in Continuum.Forms.</summary>
        public void UpdateCellValue (int columnIndex, int rowIndex) => Invalidate ();

        /// <summary>Resets the editing control for the current cell. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets which scroll bars are displayed. Stub in Continuum.Forms.</summary>
        public ScrollBars ScrollBars { get; set; } = ScrollBars.Both;

        /// <summary>Gets or sets the horizontal scrolling offset in pixels. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the grid is in virtual mode. Stub in Continuum.Forms.</summary>
        public bool VirtualMode { get; set; }

        /// <summary>Gets or sets whether the selection highlight is hidden when the control loses focus. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the control used to edit the current cell, or null if not in edit mode. Stub in Continuum.Forms.</summary>
        public Control? EditingControl => null;

        /// <summary>Gets the panel that contains editing controls. Stub in Continuum.Forms.</summary>
