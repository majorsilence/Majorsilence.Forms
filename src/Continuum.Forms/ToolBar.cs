...
namespace Continuum.Forms
{
    ...
    public class ToolBar : MenuBase
    {
        ...
        /// <summary>Gets or sets the ImageList used by this toolbar's buttons. Stub in Continuum.Forms.</summary>
        public ImageList? ImageList { get; set; }

        /// <summary>Gets or sets the size of the toolbar buttons. Stub in Continuum.Forms.</summary>
