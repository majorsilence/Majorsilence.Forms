...
public partial class Control
{
    ...
    {
        // SWF members that are unused are commented out. When Continuum Forms is more mature,
        // we can probably better determine which of these we will never use and delete them.
        Created = 0x00000001,
        Visible = 0x00000002,
        Enabled = 0x00000004,
        TabStop = 0x00000008,
        IsDirty = 0x00000010,   // Continuum.Forms addition
        IsHovering = 0x00000020,   // Continuum.Forms addition
        IsImplicitControl = 0x00000040,   // Continuum.Forms addition
        IsSelected = 0x00000080,   // Continuum.Forms addition
        //Recreate                = 0x00000010,
        //Modal                   = 0x00000020,
