...
namespace Continuum.Forms
{
    ...
    public static class Application
    {
        ...
        /// <summary>
        /// Enables visual styles for the application. No-op in Continuum.Forms.
        /// </summary>
        public static void EnableVisualStyles () { }

        /// <summary>
        /// Sets compatible text rendering default. No-op in Continuum.Forms.
        /// </summary>
        public static void SetCompatibleTextRenderingDefault (bool defaultValue) { }

        /// <summary>
        /// Sets the high DPI mode for the application. No-op in Continuum.Forms (the platform backend handles DPI automatically).
        /// </summary>
        public static bool SetHighDpiMode (HighDpiMode highDpiMode) => true;

        /// <summary>
        /// Sets the default font for the application. No-op in Continuum.Forms.
        /// </summary>
        public static void SetDefaultFont (Continuum.Drawing.Font font) { }
        ...
        /// <summary>
        /// Exits the message loop on the current thread. In Continuum.Forms this is equivalent to <see cref="Exit"/>.
        /// </summary>
        public static void ExitThread () => Exit ();

        /// <summary>
        /// Sets the application-wide color mode (light/dark/system). Stub in Continuum.Forms.
        /// </summary>
        ...
        /// <summary>Gets or sets whether the application is running in user-interactive mode. Stub in Continuum.Forms.</summary>
        public static bool UserInteractive => true;

        /// <summary>Gets or sets the format string for the caption of top-level windows. Stub in Continuum.Forms.</summary>
        public static string SafeTopLevelCaptionFormat { get; set; } = "{0}";

        /// <summary>Gets or sets the visual style state of the application. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Restarts the application. No-op in Continuum.Forms — call Environment.Exit(0) and relaunch if needed.</summary>
        public static void Restart () => Environment.Exit (0);

        /// <summary>Gets or sets the current input language. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the current UI culture. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Raised when a thread exception occurs that is not otherwise handled. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Sets the default exception handler for unhandled exceptions. Stub in Continuum.Forms.</summary>
        public static void SetUnhandledExceptionMode (UnhandledExceptionMode mode) { }

        /// <summary>Adds a message filter to the application. Stub in Continuum.Forms.</summary>
        public static void AddMessageFilter (IMessageFilter value) { }

        /// <summary>Removes a message filter from the application. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Defines a message filter for the application's message loop. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Represents a Windows message. Stub in Continuum.Forms — all fields are zero.</summary>
