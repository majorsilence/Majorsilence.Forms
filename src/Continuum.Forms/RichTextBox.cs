...
namespace Continuum.Forms
{
    ...
    /// Continuum.Forms does not render RTF; the RTF markup is stripped and plain text is shown.
    /// </summary>
    public class RichTextBox : TextBox
    {
        ...
        /// <summary>Gets or sets whether automatic URL detection is enabled. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the scroll bars to show. Stub in Continuum.Forms (always shows vertical).</summary>
        ...
        /// <summary>Loads the contents of a file into the control. Plain text only in Continuum.Forms.</summary>
        public void LoadFile (string path, RichTextBoxStreamType fileType = RichTextBoxStreamType.PlainText)
        {
            Text = System.IO.File.ReadAllText (path);
        }

        /// <summary>Loads from a stream into the control. Plain text only in Continuum.Forms.</summary>
        ...
        /// <summary>Saves the contents of the control to a file. Plain text only in Continuum.Forms.</summary>
        public void SaveFile (string path, RichTextBoxStreamType fileType = RichTextBoxStreamType.PlainText)
        {
            System.IO.File.WriteAllText (path, Text);
        }

        /// <summary>Saves the contents of the control to a stream. Plain text only in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the color of the currently selected text. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color SelectionColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the font of the currently selected text. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Font? SelectionFont { get; set; }

        /// <summary>Gets or sets the alignment of the currently selected text. Stub in Continuum.Forms.</summary>
        public HorizontalAlignment SelectionAlignment { get; set; } = HorizontalAlignment.Left;

        /// <summary>Gets or sets the indentation of the currently selected text. Stub in Continuum.Forms.</summary>
        public int SelectionIndent { get; set; }

        /// <summary>Gets or sets whether the current selection or insertion point is bulleted. Stub in Continuum.Forms.</summary>
        public bool SelectionBullet { get; set; }

        /// <summary>Gets or sets whether the selected text has bold formatting. Stub in Continuum.Forms.</summary>
        public bool SelectionBold { get; set; }

        /// <summary>Gets or sets whether the selected text has italic formatting. Stub in Continuum.Forms.</summary>
        public bool SelectionItalic { get; set; }

        /// <summary>Gets or sets whether the selected text is underlined. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the bullet indent size. Stub in Continuum.Forms.</summary>
        public int BulletIndent { get; set; }

        /// <summary>Gets or sets the background color of the selected text. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the zoom factor. Stub in Continuum.Forms (always 1.0).</summary>
        public float ZoomFactor { get; set; } = 1.0f;

        /// <summary>Gets or sets whether auto-drag-drop is enabled. Stub in Continuum.Forms.</summary>
        public bool EnableAutoDragDrop { get; set; }

        /// <summary>Gets or sets the right-edge indentation of the selection. Stub in Continuum.Forms.</summary>
        public int SelectionRightIndent { get; set; }

        /// <summary>Gets or sets the hanging indent of the selection. Stub in Continuum.Forms.</summary>
        public int SelectionHangingIndent { get; set; }

        /// <summary>Gets or sets the character offset (superscript/subscript) of the selection. Stub in Continuum.Forms.</summary>
        public int SelectionCharOffset { get; set; }

        /// <summary>Gets or sets whether the selected text is protected from editing. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Returns the character index of the character at the specified location. Stub in Continuum.Forms.</summary>
        public int GetCharIndexFromPosition (System.Drawing.Point pt) => SelectionStart;

        /// <summary>Returns the location of the character at the specified index. Stub in Continuum.Forms.</summary>
        public System.Drawing.Point GetPositionFromCharIndex (int index) => System.Drawing.Point.Empty;

        /// <summary>Paste from the clipboard into the specified format. Stub in Continuum.Forms (pastes plain text).</summary>
        public void Paste (DataFormat clipFormat) => base.Paste ();

        /// <summary>Raised when the control's contents are resized. Stub in Continuum.Forms.</summary>
        public event EventHandler<ContentsResizedEventArgs>? ContentsResized { add { } remove { } }

        /// <summary>Raised when the user clicks a link in the RichTextBox. Stub in Continuum.Forms.</summary>
        public event EventHandler<LinkClickedEventArgs>? LinkClicked { add { } remove { } }

        /// <summary>Raised when the selection changes. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>WinForms compatibility: represents a clipboard data format. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>WinForms compatibility: provides static members for clipboard data formats. Stub in Continuum.Forms.</summary>
