...
namespace Continuum.Forms
{
    ...
    public abstract class FileDialog : FileSystemDialog
    {
        ...
        /// <summary>Gets or sets the index of the currently selected filter (1-based). Stub in Continuum.Forms.</summary>
        public int FilterIndex { get; set; } = 1;

        /// <summary>Gets or sets the default extension added to file names without an extension.</summary>
        public string DefaultExt { get; set; } = string.Empty;

        /// <summary>Gets or sets whether to add the extension automatically. Stub in Continuum.Forms.</summary>
        public bool AddExtension { get; set; } = true;

        /// <summary>Gets or sets whether shortcuts should be dereferenced. Stub in Continuum.Forms.</summary>
        public bool DereferenceLinks { get; set; } = true;

        /// <summary>Gets or sets a help button. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the dialog validates file names. Stub in Continuum.Forms.</summary>
