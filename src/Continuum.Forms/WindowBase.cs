...
namespace Continuum.Forms
{
    ...
    public abstract partial class WindowBase : Component
    {
        ...
        internal Continuum.Forms.Backends.IWindowBackend Backend = null!;
        ...
        {
            Continuum.Forms.Backends.Platform.Backend.Initialize ();
        }
        ...
        /// </summary>
        internal void InitWindow (Continuum.Forms.Backends.IWindowBackend backend)
        {
            Backend = backend;
        ...
        /// <summary>
        /// Renders one frame of the Continuum.Forms scene into the supplied SkiaSharp canvas. This is the
        ...
        public void BeginInvoke (Action action)
        {
            ...
            Continuum.Forms.Backends.Platform.Backend.Post (action);
        }
        ...
        {
            ArgumentNullException.ThrowIfNull (action);
            Continuum.Forms.Backends.Platform.Backend.Invoke (action);
        }
