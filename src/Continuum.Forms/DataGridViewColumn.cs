...
namespace Continuum.Forms
{
    ...
    public class DataGridViewColumn
    {
        ...
        /// <summary>Gets or sets the auto-size mode. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the template used to create new cells. Stub in Continuum.Forms.</summary>
        public DataGridViewCell? CellTemplate { get; set; }

        /// <summary>Gets or sets the display order of the column. Stub in Continuum.Forms.</summary>
