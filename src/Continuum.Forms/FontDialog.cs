...
namespace Continuum.Forms
{
    ...
    public class FontDialog : Form
    {
        ...
        // Continuum.Drawing.Font is only supported on Windows, so it is constructed lazily; merely
        ...
        /// <summary>Gets or sets whether the user can change the character set. Stub in Continuum.Forms.</summary>
        public bool AllowScriptChange { get; set; } = true;

        /// <summary>Gets or sets whether simulated fonts are shown. Stub in Continuum.Forms.</summary>
        public bool AllowSimulations { get; set; } = true;

        /// <summary>Gets or sets whether vector fonts are shown. Stub in Continuum.Forms.</summary>
        public bool AllowVectorFonts { get; set; } = true;

        /// <summary>Gets or sets whether vertical fonts are shown. Stub in Continuum.Forms.</summary>
        public bool AllowVerticalFonts { get; set; } = true;

        /// <summary>Gets or sets whether only fixed-pitch fonts are shown. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the Apply button is shown. Stub in Continuum.Forms.</summary>
        public bool ShowApply { get; set; }

        /// <summary>Gets or sets whether font effects (strikeout, underline) are shown. Stub in Continuum.Forms.</summary>
        public bool ShowEffects { get; set; } = true;

        /// <summary>Gets or sets whether the Help button is shown. Stub in Continuum.Forms.</summary>
        public bool ShowHelp { get; set; }

        /// <summary>Raised when the Apply button is clicked. Stub in Continuum.Forms.</summary>
