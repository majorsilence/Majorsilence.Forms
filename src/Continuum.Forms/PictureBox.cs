...
namespace Continuum.Forms
{
    ...
    public class PictureBox : Control
    {
        ...
        private Continuum.Drawing.Image? _systemImage;
        ...
        /// <summary>Sets the image from a <see cref="Continuum.Drawing.Bitmap"/>.</summary>
        public void SetImage (Continuum.Drawing.Bitmap bitmap) => Image = bitmap;

        /// <summary>Sets the image from a SKBitmap for Continuum.Forms usage.</summary>
        ...
        /// <summary>Gets or sets the border style of the PictureBox. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the image shown when the primary image load fails. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Image? ErrorImage { get; set; }

        /// <summary>Gets or sets the image shown while the primary image is loading. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Image? InitialImage { get; set; }

        /// <summary>Loads the image from the specified URL asynchronously. Stub delegates to Load() in Continuum.Forms.</summary>
        public void LoadAsync (string url) => Load (url);

        /// <summary>Cancels a pending asynchronous image load. Stub in Continuum.Forms.</summary>
        public void CancelAsync () { }

        /// <summary>Raised when an asynchronous load completes. Stub in Continuum.Forms.</summary>
        public event EventHandler? LoadCompleted { add { } remove { } }

        /// <summary>Raised to report progress of an asynchronous load. Stub in Continuum.Forms.</summary>
