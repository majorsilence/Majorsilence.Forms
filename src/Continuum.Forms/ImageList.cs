...
public class ImageList : Component
{
    ...
    /// <summary>Gets or sets the color depth used by the image list. Stored but not enforced in Continuum.Forms.</summary>
    public ColorDepth ColorDepth { get; set; } = ColorDepth.Depth32Bit;

    /// <summary>Gets or sets the color to treat as transparent. Stub in Continuum.Forms (images keep their own alpha).</summary>
    ...
    /// Stub in Continuum.Forms — accepting a deserialized <see cref="ImageListStreamer"/> is supported for
...
/// Stub in Continuum.Forms — accepted for source compatibility but not unpacked.
/// </summary>
