...
namespace Continuum.Forms
{
    ...
    public class Button : Control, IHaveTextAndImageAlign
    {
        ...
        /// <summary>Gets or sets the flat style appearance of the button. Stub in Continuum.Forms.</summary>
        public FlatStyle FlatStyle { get; set; } = FlatStyle.Standard;

        /// <summary>Gets the appearance settings used when the button has a flat appearance. Stub in Continuum.Forms.</summary>
        public FlatButtonAppearance FlatAppearance { get; } = new FlatButtonAppearance ();

        /// <summary>Gets or sets whether the button uses the system visual style. Stub in Continuum.Forms.</summary>
