...
namespace Continuum.Forms
{
    ...
    public class ListViewItem
    {
        ...
        /// <summary>
        /// Gets or sets the image displayed on the item. Accepts <see cref="Continuum.Drawing.Image"/> for WinForms compatibility.
        /// </summary>
...
#pragma warning restore CA1416
        ...
        /// <summary>Gets or sets whether subitems inherit the style of the parent item. Stub in Continuum.Forms.</summary>
        public bool UseItemStyleForSubItems { get; set; } = true;

        /// <summary>Gets or sets the tooltip text for the item. Stub in Continuum.Forms.</summary>
        public string ToolTipText { get; set; } = string.Empty;

        /// <summary>Gets or sets the index of the state image for the item. Stub in Continuum.Forms.</summary>
        public int StateImageIndex { get; set; } = -1;

        /// <summary>Gets or sets the number of small image widths by which to indent the item. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the position of this item in virtual coordinates. Stub in Continuum.Forms.</summary>
        public System.Drawing.Point Position { get; set; }

        /// <summary>Ensures the item is scrolled into view.</summary>
        public void EnsureVisible () => Parent?.EnsureVisible (Index);

        /// <summary>Begins in-place editing of the item's label. Stub in Continuum.Forms.</summary>
...
#pragma warning disable CA1416
            ...
            public ListViewSubItem (string text, System.Drawing.Color foreColor, System.Drawing.Color backColor, Continuum.Drawing.Font font)
            {
                Text = text;
                ForeColor = foreColor;
                BackColor = backColor;
...
#pragma warning disable CA1416
            ...
            public ListViewSubItem Add (string text, System.Drawing.Color foreColor, System.Drawing.Color backColor, Continuum.Drawing.Font font)
            {
