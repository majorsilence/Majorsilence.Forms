...
namespace Continuum.Forms
{
    ...
    public class ListBox : Control
    {
        ...
        /// <summary>Gets or sets the height of each item when DrawMode is OwnerDrawFixed. Stub in Continuum.Forms.</summary>
        public DrawMode DrawMode { get; set; } = DrawMode.Normal;

        /// <summary>Gets or sets whether the control height resizes to avoid showing partial items. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the horizontal extent to enable horizontal scrolling. Stub in Continuum.Forms.</summary>
        public int HorizontalExtent { get; set; }

        /// <summary>Gets or sets whether tab stops are used in the ListBox. Stub in Continuum.Forms.</summary>
        public bool UseTabStops { get; set; } = true;

        /// <summary>Gets or sets whether the ListBox always shows a scroll bar. Stub in Continuum.Forms.</summary>
        public bool ScrollAlwaysVisible { get; set; }

        /// <summary>Gets or sets whether a horizontal scrollbar is shown. Stub in Continuum.Forms.</summary>
        public bool HorizontalScrollbar { get; set; }

        /// <summary>Gets or sets whether the ListBox displays items in multiple columns. Stub in Continuum.Forms.</summary>
        public bool MultiColumn { get; set; }

        /// <summary>Gets or sets whether formatting is applied to the DisplayMember. Stub in Continuum.Forms.</summary>
        public bool FormattingEnabled { get; set; }

        /// <summary>Gets or sets the width of each column in a multi-column ListBox. Stub in Continuum.Forms.</summary>
        public int ColumnWidth { get; set; }

        /// <summary>Gets or sets the index of the first visible item. Stub in Continuum.Forms.</summary>
        public int TopIndex {
            get => top_index;
            set {
        ...
        /// <summary>Raised when items are added. Stub in Continuum.Forms.</summary>
        public event EventHandler<MeasureItemEventArgs>? MeasureItem { add { } remove { } }

        /// <summary>Raised when an item needs to be drawn (OwnerDraw). Stub in Continuum.Forms.</summary>
