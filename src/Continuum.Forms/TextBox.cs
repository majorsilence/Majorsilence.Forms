...
namespace Continuum.Forms
{
    ...
    public class TextBox : ScrollControl
    {
        ...
        public void Copy ()
        {
            ...
            AsyncHelper.RunSync (() => Continuum.Forms.Clipboard.SetTextAsync (text));
        }
        ...
        /// <summary>
        /// Gets or sets which scroll bars appear (informational; Continuum.Forms shows scroll bars automatically).
        /// </summary>
        ...
        public void Paste ()
        {
            ...
            var text = AsyncHelper.RunSync (() => Continuum.Forms.Clipboard.GetTextAsync ());
        ...
        /// <summary>Gets or sets whether pressing Enter in a multiline TextBox creates a new line. Stub in Continuum.Forms.</summary>
        public bool AcceptsReturn { get; set; }

        /// <summary>Gets or sets whether pressing Tab in a TextBox inserts a tab character. Stub in Continuum.Forms.</summary>
        public bool AcceptsTab { get; set; }

        /// <summary>Gets or sets the character casing applied to text. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the auto-complete source. Stub in Continuum.Forms.</summary>
        public AutoCompleteSource AutoCompleteSource { get; set; } = AutoCompleteSource.None;

        /// <summary>Gets or sets a custom list of strings used for auto-complete. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the system's default password character is used. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Undoes the last edit. Stub in Continuum.Forms.</summary>
        public void Undo () { }

        /// <summary>Clears the undo buffer. Stub in Continuum.Forms.</summary>
        public void ClearUndo () { }

        /// <summary>Raised when the TextAlign property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? TextAlignChanged { add { } remove { } }

        /// <summary>Raised when the AcceptsTab property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? AcceptsTabChanged { add { } remove { } }

        /// <summary>Gets or sets whether the text has been modified since it was last set. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the horizontal alignment of text in the TextBox. Stub in Continuum.Forms.</summary>
        public HorizontalAlignment TextAlign { get; set; } = HorizontalAlignment.Left;

        /// <summary>Gets or sets the border style of the text box. Stub in Continuum.Forms.</summary>
