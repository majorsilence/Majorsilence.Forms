...
public partial class Control
{
    ...
    /// <summary>Raised when a drag-and-drop operation enters the control. Stub in Continuum.Forms.</summary>
    public event EventHandler<DragEventArgs>? DragEnter { add { } remove { } }

    /// <summary>Raised when the user drags an object over the control. Stub in Continuum.Forms.</summary>
    public event EventHandler<DragEventArgs>? DragOver { add { } remove { } }

    /// <summary>Raised when a drag-and-drop operation leaves the control. Stub in Continuum.Forms.</summary>
    public event EventHandler? DragLeave { add { } remove { } }

    /// <summary>Raised when a drag-and-drop operation is completed. Stub in Continuum.Forms.</summary>
    public event EventHandler<DragEventArgs>? DragDrop { add { } remove { } }

    /// <summary>Raised during a drag-and-drop to provide cursor feedback. Stub in Continuum.Forms.</summary>
    public event EventHandler<GiveFeedbackEventArgs>? GiveFeedback { add { } remove { } }

    /// <summary>Raised to determine whether a drag-and-drop should continue. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Raised when the control is moved. Alias for LocationChanged. Stub in Continuum.Forms.</summary>
    public event EventHandler? Move { add { } remove { } }

    /// <summary>Raised when the BackColor property changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? BackColorChanged { add { } remove { } }

    /// <summary>Raised when the ForeColor property changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? ForeColorChanged { add { } remove { } }

    /// <summary>Raised when the Font property changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? FontChanged { add { } remove { } }

    /// <summary>Raised when the control's handle is created. Stub in Continuum.Forms (always created).</summary>
    public event EventHandler? HandleCreated { add { } remove { } }

    /// <summary>Raised when the control's handle is destroyed. Stub in Continuum.Forms.</summary>
    public event EventHandler? HandleDestroyed { add { } remove { } }

    /// <summary>Raised when the mouse is captured or released. Stub in Continuum.Forms.</summary>
    public event EventHandler? MouseCaptureChanged { add { } remove { } }

    /// <summary>Raised when the mouse pointer hovers over the control. Stub in Continuum.Forms.</summary>
    public event EventHandler? MouseHover { add { } remove { } }

    /// <summary>Raised before a key event to allow the key to be previewed. Stub in Continuum.Forms.</summary>
    public event EventHandler<PreviewKeyDownEventArgs>? PreviewKeyDown { add { } remove { } }

    /// <summary>Raised when the control is added to a container control. Stub in Continuum.Forms.</summary>
    public event EventHandler? ChangeUICues { add { } remove { } }

    /// <summary>Raised when the control's HelpRequested event fires. Stub in Continuum.Forms.</summary>
    public event HelpEventHandler? HelpRequested { add { } remove { } }

    /// <summary>Raised when component is being queried for help. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Raised when the user scrolls the control. Stub in Continuum.Forms.</summary>
    public event ScrollEventHandler? Scroll { add { } remove { } }

    /// <summary>Raised when the DPI scaling of the control changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? DpiChangedAfterParent { add { } remove { } }

    /// <summary>Raised before the DPI scaling of the control changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? DpiChangedBeforeParent { add { } remove { } }

    /// <summary>Raised when the data binding context changes. Stub in Continuum.Forms.</summary>
    public event EventHandler? BindingContextChanged { add { } remove { } }

    /// <summary>Raised when the system colors change. Stub in Continuum.Forms.</summary>
