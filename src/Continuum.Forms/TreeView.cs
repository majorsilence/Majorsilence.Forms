...
namespace Continuum.Forms
{
    ...
    public class TreeView : Control
    {
        ...
        /// <summary>Raised when the user begins dragging a node. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether clicking a tree node selects the full row. Stub in Continuum.Forms.</summary>
        public bool FullRowSelect { get; set; }

        /// <summary>Gets or sets whether selections remain highlighted when the control loses focus. Stub in Continuum.Forms.</summary>
        public bool HideSelection { get; set; }

        /// <summary>Gets or sets the height of each tree node row in pixels.</summary>
        public int ItemHeight { get; set; } = 20;

        /// <summary>Gets or sets whether in-place label editing is enabled. Stub in Continuum.Forms.</summary>
        public bool LabelEdit { get; set; }

        /// <summary>Gets or sets the separator character used in node paths.</summary>
        public string PathSeparator { get; set; } = "\\";

        /// <summary>Gets or sets whether lines are drawn between tree nodes. Stub in Continuum.Forms.</summary>
        public bool ShowLines { get; set; } = true;

        /// <summary>Gets or sets whether expand/collapse buttons are shown. Stub in Continuum.Forms.</summary>
        public bool ShowPlusMinus { get; set; } = true;

        /// <summary>Gets or sets whether root-level tree lines are drawn. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether nodes are highlighted when the mouse pointer hovers over them. Stub in Continuum.Forms.</summary>
        public bool HotTracking { get; set; }

        /// <summary>Gets or sets the ImageList used for state images. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the first visible node in the tree. Stub in Continuum.Forms.</summary>
        public TreeViewItem? TopNode {
            get => Items.FirstOrDefault ();
            set { }
        }

        /// <summary>Gets or sets the object used to sort tree nodes. Stub in Continuum.Forms.</summary>
        public System.Collections.IComparer? TreeViewNodeSorter { get; set; }

        /// <summary>Sorts all nodes in the tree using the default string comparison. Stub in Continuum.Forms.</summary>
        public void Sort () { }
