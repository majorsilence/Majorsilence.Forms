...
namespace Continuum.Forms
{
    ...
    public class FolderBrowserDialog : FileSystemDialog
    {
        ...
        /// <summary>Gets or sets the descriptive text above the tree view. Stub in Continuum.Forms (used as window title). Setting null coerces to an empty string.</summary>
        public string Description {
            get => description;
            set => description = value ?? string.Empty;
        }

        /// <summary>Gets or sets whether a New Folder button is shown. Stub in Continuum.Forms.</summary>
        public bool ShowNewFolderButton { get; set; } = true;

        /// <summary>Gets or sets whether the description is used as the dialog title. Stub in Continuum.Forms.</summary>
        public bool UseDescriptionForTitle { get; set; }

        /// <summary>Gets or sets the root folder at which to start browsing. Stub in Continuum.Forms.</summary>
