...
{
    /// <summary>Telerik-compat button. Backed by <see cref="Continuum.Forms.Button"/>.</summary>
    ...
    /// <summary>Telerik-compat label. Backed by <see cref="Continuum.Forms.Label"/>.</summary>
    ...
    /// <summary>Telerik-compat link label. Backed by <see cref="Continuum.Forms.LinkLabel"/>.</summary>
    public class RadLinkLabel : LinkLabel { }

    /// <summary>Telerik-compat text box. Backed by <see cref="Continuum.Forms.TextBox"/>.</summary>
    ...
    /// <summary>Telerik-compat text box control. Backed by <see cref="Continuum.Forms.TextBox"/>.</summary>
    ...
    /// <summary>Telerik-compat check box. Backed by <see cref="Continuum.Forms.CheckBox"/>.</summary>
    public class RadCheckBox : CheckBox
    {
        ...
        public ToggleState ToggleState {
            get => CheckState switch {
                Continuum.Forms.CheckState.Checked => ToggleState.On,
                Continuum.Forms.CheckState.Indeterminate => ToggleState.Indeterminate,
                _ => ToggleState.Off
            };
            set => CheckState = value switch {
                ToggleState.On => Continuum.Forms.CheckState.Checked,
                ToggleState.Indeterminate => Continuum.Forms.CheckState.Indeterminate,
                _ => Continuum.Forms.CheckState.Unchecked
            };
        }
    ...
    /// <summary>Telerik-compat radio button. Backed by <see cref="Continuum.Forms.RadioButton"/>.</summary>
    ...
    /// <summary>Telerik-compat on/off switch. Backed by <see cref="Continuum.Forms.CheckBox"/>.</summary>
    ...
    /// <summary>Telerik-compat group box. Backed by <see cref="Continuum.Forms.GroupBox"/>.</summary>
    ...
    /// <summary>Telerik-compat panel. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    ...
    /// <summary>Telerik-compat form. Backed by <see cref="Continuum.Forms.Form"/>.</summary>
    ...
    /// <summary>Telerik-compat ribbon form. Backed by <see cref="Continuum.Forms.Form"/>.</summary>
    public class RadRibbonForm : RadForm { }

    /// <summary>Telerik-compat indeterminate progress / waiting indicator. Backed by <see cref="Continuum.Forms.ProgressBar"/>.</summary>
    ...
    /// <summary>Telerik-compat list control. Backed by <see cref="Continuum.Forms.ListBox"/>.</summary>
    ...
    /// <summary>Telerik-compat date/time picker. Backed by <see cref="Continuum.Forms.DateTimePicker"/>.</summary>
