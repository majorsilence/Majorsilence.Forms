...
{
    /// <summary>Telerik-compat status strip. Backed by <see cref="Continuum.Forms.Control"/>.</summary>
    ...
    /// <summary>Telerik-compat command bar. Backed by <see cref="Continuum.Forms.Control"/>.</summary>
    ...
    /// <summary>Telerik-compat menu. Backed by <see cref="Continuum.Forms.Menu"/>.</summary>
    public class RadMenu : Menu { }

    /// <summary>Telerik-compat menu item. Backed by <see cref="Continuum.Forms.MenuItem"/>.</summary>
    ...
    /// <summary>Telerik-compat property grid. Backed by <see cref="Continuum.Forms.Control"/>.</summary>
    public class RadPropertyGrid : PropertyGrid
    {
        ...
        // inspected object's properties are inherited from Continuum.Forms.PropertyGrid.
    ...
    /// <summary>Telerik-compat scheduler. Backed by <see cref="Continuum.Forms.Control"/>. No scheduling UI is implemented.</summary>
    ...
    /// <summary>Telerik-compat scheduler navigator. Backed by <see cref="Continuum.Forms.Control"/>.</summary>
    ...
    /// <summary>Telerik-compat layout control. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    ...
    /// <summary>Telerik-compat layout item. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    public class LayoutControlItem : Panel { }

    /// <summary>Telerik-compat layout group. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
