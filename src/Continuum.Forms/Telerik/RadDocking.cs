...
{
    /// <summary>
    /// Telerik-compat docking manager. Backed by <see cref="Continuum.Forms.Panel"/>. Docking is not
    ...
    /// <summary>Base for Telerik dock windows. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    ...
    /// <summary>Telerik-compat tool tab strip. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    ...
    /// <summary>Telerik-compat document tab strip. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
    ...
    /// <summary>Telerik-compat document container. Backed by <see cref="Continuum.Forms.Panel"/>.</summary>
