...
{
    /// <summary>Telerik-compat drop-down list. Backed by <see cref="Continuum.Forms.ComboBox"/>.</summary>
    ...
    /// <summary>
    /// Telerik-compat multi-select checked drop-down list. Backed by <see cref="Continuum.Forms.ComboBox"/>;
