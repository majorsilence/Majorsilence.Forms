...
public class ImageCollection : IDictionary<string, SKBitmap>
{
    ...
    /// <summary>Adds a Continuum.Drawing.Image to the collection with an auto-generated key.</summary>
    public void Add (Continuum.Drawing.Image image)
    {
        if (image is null) return;
    ...
    /// <summary>Adds a Continuum.Drawing.Image to the collection with the specified key.</summary>
    public void Add (string key, Continuum.Drawing.Image image)
    {
        var bmp = image?.ToSKBitmap ();
    ...
    /// <summary>Adds a Continuum.Drawing.Icon to the collection with an auto-generated key.</summary>
    public void Add (Continuum.Drawing.Icon icon)
    {
    ...
    /// <summary>Adds a Continuum.Drawing.Icon to the collection with the specified key.</summary>
    public void Add (string key, Continuum.Drawing.Icon icon)
    {
        if (icon is null) return;
        using var bmp = icon.ToBitmap ();
        Add (key, (Continuum.Drawing.Image)bmp);
    }

    /// <summary>Adds a range of images to the collection.</summary>
    public void AddRange (Continuum.Drawing.Image[] images)
    {
