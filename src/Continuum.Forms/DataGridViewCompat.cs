...
namespace Continuum.Forms
{
    ...
    public class DataGridViewCellStyle : ICloneable
    {
        ...
        /// <summary>Gets or sets the font used to display text. Stub in Continuum.Forms.</summary>
...
#pragma warning restore CA1416
        ...
        /// <summary>Gets the scope of the style. Always <see cref="DataGridViewCellStyleScopes.None"/> in Continuum.Forms.</summary>
    ...
    /// <summary>Defines the scope to which a DataGridViewCellStyle applies. Continuum.Forms only exposes <see cref="None"/>.</summary>
    [Flags]
    ...
    /// <summary>
    /// Represents an image column in a DataGridView. Stub in Continuum.Forms (images are not rendered).
    /// </summary>
    public class DataGridViewImageColumn : DataGridViewColumn
    {
        /// <summary>Gets or sets the image displayed in the column. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Image? Image { get; set; }

        /// <summary>Gets or sets the description of the image. Stub in Continuum.Forms.</summary>
        public string Description { get; set; } = string.Empty;
    }

    /// <summary>
    /// Represents a link column in a DataGridView. Stub in Continuum.Forms.
    /// </summary>
    public class DataGridViewLinkColumn : DataGridViewColumn
    {
        /// <summary>Gets or sets the link text. Stub in Continuum.Forms.</summary>
        public string Text { get; set; } = string.Empty;

        /// <summary>Gets or sets the active link color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color ActiveLinkColor { get; set; } = System.Drawing.Color.Red;

        /// <summary>Gets or sets the link color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color LinkColor { get; set; } = System.Drawing.Color.Blue;

        /// <summary>Gets or sets the visited link color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color VisitedLinkColor { get; set; } = System.Drawing.Color.Purple;

        /// <summary>Gets or sets whether the link tracking is enabled. Stub in Continuum.Forms.</summary>
        public bool TrackVisitedState { get; set; } = true;

        /// <summary>Gets or sets whether the column header text is used as link text. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Provides data for the DataGridView.RowPrePaint event. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Provides data for the DataGridView.RowPostPaint event. Stub in Continuum.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    /// <summary>Represents a text-box cell in a DataGridView. Stub in Continuum.Forms.</summary>
    public class DataGridViewTextBoxCell : DataGridViewCell { }

    /// <summary>Represents a check-box cell in a DataGridView. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Represents a combo-box cell in a DataGridView. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Represents an image cell in a DataGridView. Stub in Continuum.Forms.</summary>
