...
namespace Continuum.Forms
{
    ...
    /// Continuum.Forms has no native tray support, so this is a stub that keeps the API surface
    ...
    public class NotifyIcon : Component
    {
        ...
        /// Continuum.Forms has no native tray support, so no balloon is shown, but argument validation
        /// matches WinForms.
        /// </summary>
        ...
        /// <summary>
        /// Displays a balloon notification with the specified title and text. Continuum.Forms has no
