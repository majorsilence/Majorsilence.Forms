...
namespace Continuum.Forms
{
    ...
    public class NumericUpDown : Control, System.ComponentModel.ISupportInitialize
    {
        ...
        /// <summary>Gets a value indicating whether the user has edited the text in the spin box. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the alignment of the text in the control. Stub in Continuum.Forms.</summary>
        public HorizontalAlignment TextAlign { get; set; } = HorizontalAlignment.Left;

        /// <summary>Gets or sets whether the up/down buttons are aligned to the left. Stub in Continuum.Forms.</summary>
