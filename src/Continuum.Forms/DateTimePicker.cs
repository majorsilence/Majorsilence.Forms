...
namespace Continuum.Forms
{
    ...
    /// Built on TimePicker for Continuum.Forms compatibility.
    /// </summary>
    public class DateTimePicker : TextBox
    {
        ...
        /// <summary>Gets or sets the font used for the calendar portion. Stub in Continuum.Forms.</summary>
        public Continuum.Drawing.Font? CalendarFont { get; set; }
        ...
        /// <summary>Gets or sets whether a checkbox is displayed to the left of the selected date. Stub in Continuum.Forms.</summary>
        public bool ShowCheckBox { get; set; }

        /// <summary>Gets or sets whether the date/time value is enabled (meaningful when ShowCheckBox is true). Stub in Continuum.Forms.</summary>
        public bool Checked { get; set; } = true;

        /// <summary>Gets or sets the calendar's foreground color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color CalendarForeColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the calendar's background color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color CalendarMonthBackground { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the calendar's title foreground color. Stub in Continuum.Forms.</summary>
        public System.Drawing.Color CalendarTitleForeColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the calendar's title background color. Stub in Continuum.Forms.</summary>
