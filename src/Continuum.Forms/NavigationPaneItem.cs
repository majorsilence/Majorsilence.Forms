...
public class NavigationPaneItem : ILayoutable
{
    ...
    /// <summary>
    /// Initializes a new instance of the NavigationPaneItem class with a Continuum.Drawing.Image.
    /// </summary>
#pragma warning disable CA1416
    public NavigationPaneItem (Continuum.Drawing.Image image, string? text = null)
    {
        _image = image;
