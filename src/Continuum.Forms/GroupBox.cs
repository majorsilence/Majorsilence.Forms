...
namespace Continuum.Forms
{
    ...
    public class GroupBox : Control
    {
        ...
        /// <summary>Gets or sets the flat style of the group box. Stub in Continuum.Forms.</summary>
        public FlatStyle FlatStyle { get; set; } = FlatStyle.Standard;

        /// <summary>Gets or sets whether compatible text rendering is used. Stub in Continuum.Forms.</summary>
        public bool UseCompatibleTextRendering { get; set; } = true;

        /// <summary>Gets or sets whether the group box is auto-sized. Stub in Continuum.Forms.</summary>
