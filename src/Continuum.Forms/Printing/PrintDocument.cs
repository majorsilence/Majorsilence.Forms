...
namespace Continuum.Forms.Printing
{
    ...
    public class PrintDocument
    {
        ...
        /// <summary>Raised before each page is printed to allow per-page settings changes. Stub in Continuum.Forms.</summary>
        public event EventHandler<QueryPageSettingsEventArgs>? QueryPageSettings;

        /// <summary>Gets or sets whether the origin of the graphics object is at the user-defined margins. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the print controller. Stored but not used in Continuum.Forms — the PDF pipeline is always used.</summary>
    ...
    /// <summary>Abstract base class for print controllers. Stub in Continuum.Forms.</summary>
    public abstract class PrintController
    {
    }

    /// <summary>Sends print jobs directly to the printer. Stub in Continuum.Forms — the PDF pipeline is always used.</summary>
    public class StandardPrintController : PrintController
    {
    }

    /// <summary>Wraps a PrintController and shows a status dialog. Stub in Continuum.Forms.</summary>
    ...
    /// <summary>Represents a print controller that drives a PrintPreviewControl. Stub in Continuum.Forms.</summary>
