namespace Continuum.Forms.Printing
{
    /// <summary>
    ...
    public sealed class PageSettings
    {
        ...
        /// <summary>Gets or sets the paper size. Stub in Continuum.Forms.</summary>
        public PaperSize PaperSize {
            get => new PaperSize ("Custom", PaperWidth, PaperHeight);
            set { PaperWidth = value.Width; PaperHeight = value.Height; }
        }

        /// <summary>Gets or sets the paper source. Stub in Continuum.Forms.</summary>
        public PaperSource PaperSource { get; set; } = new PaperSource ();

        /// <summary>Gets or sets the printer resolution. Stub in Continuum.Forms.</summary>
        public PrinterResolution PrinterResolution { get; set; } = new PrinterResolution ();

        /// <summary>Gets or sets whether to print in color. Stub in Continuum.Forms.</summary>
    ...
    public class PaperSize
    {
        ...
        /// <summary>Gets or sets the paper kind. Stub in Continuum.Forms.</summary>
    ...
    {
        /// <summary>Gets or sets the name of the paper source. Stub in Continuum.Forms.</summary>
        public string SourceName { get; set; } = "Auto";

        /// <summary>Gets or sets the paper source kind. Stub in Continuum.Forms.</summary>
    ...
    {
        /// <summary>Gets or sets the horizontal resolution in DPI. Stub in Continuum.Forms.</summary>
        public int X { get; set; } = 600;

        /// <summary>Gets or sets the vertical resolution in DPI. Stub in Continuum.Forms.</summary>
        public int Y { get; set; } = 600;

        /// <summary>Gets or sets the resolution kind. Stub in Continuum.Forms.</summary>
