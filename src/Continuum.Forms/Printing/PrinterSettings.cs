namespace Continuum.Forms.Printing
{
    ...
    public sealed class PrinterSettings
    {
        ...
        /// <summary>Gets or sets whether this is the default printer. Stub in Continuum.Forms.</summary>
        public bool IsDefaultPrinter => true;

        /// <summary>Gets or sets whether the printer settings are valid. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the printer supports duplex printing. Stub in Continuum.Forms.</summary>
        public bool CanDuplex => false;

        /// <summary>Gets or sets the duplex setting. Stub in Continuum.Forms.</summary>
        public Duplex Duplex { get; set; } = Duplex.Simplex;

        /// <summary>Gets or sets the file name when printing to a file. Stub in Continuum.Forms.</summary>
        public string PrintFileName { get; set; } = string.Empty;

        /// <summary>Gets the list of installed printers. Stub in Continuum.Forms — returns empty collection.</summary>
