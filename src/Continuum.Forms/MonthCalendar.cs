...
namespace Continuum.Forms
{
    ...
    /// Stub in Continuum.Forms — renders as a simple label showing the selected date.
    /// </summary>
    public class MonthCalendar : Control
    {
        ...
        /// <summary>Gets or sets the number of months to display at once. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the first day of the week. Stub in Continuum.Forms.</summary>
        public Day FirstDayOfWeek { get; set; } = Day.Default;

        /// <summary>Gets or sets whether week numbers are shown. Stub in Continuum.Forms.</summary>
        public bool ShowWeekNumbers { get; set; }

        /// <summary>Gets or sets whether today's date is circled. Stub in Continuum.Forms.</summary>
        public bool ShowToday { get; set; } = true;

        /// <summary>Gets or sets whether today's date is shown at the bottom. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets the title foreground color. Stub in Continuum.Forms.</summary>
        public Color TitleForeColor { get; set; } = Color.Empty;

        /// <summary>Gets or sets the title background color. Stub in Continuum.Forms.</summary>
        public Color TitleBackColor { get; set; } = Color.Empty;

        /// <summary>Gets or sets the trailing foreground color. Stub in Continuum.Forms.</summary>
