...
namespace Continuum.Forms
{
    ...
    public class ListView : Control
    {
        ...
        /// <summary>Gets or sets the sort order for items. Stub in Continuum.Forms.</summary>
        public SortOrder Sorting { get; set; } = SortOrder.None;

        /// <summary>Gets or sets whether items can be grouped. Stub in Continuum.Forms.</summary>
        public bool ShowGroups { get; set; } = true;

        /// <summary>Gets or sets whether labels are automatically arranged. Stub in Continuum.Forms.</summary>
        public bool AutoArrange { get; set; } = true;

        /// <summary>Gets or sets the style of column headers. Stub in Continuum.Forms.</summary>
        public ColumnHeaderStyle HeaderStyle { get; set; } = ColumnHeaderStyle.Clickable;

        /// <summary>Gets or sets the activation method for items. Stub in Continuum.Forms.</summary>
        public ItemActivation Activation { get; set; } = ItemActivation.Standard;

        /// <summary>Gets or sets whether the user can reorder columns. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Raised when the user begins dragging a list item. Stub in Continuum.Forms.</summary>
...
#pragma warning restore CA1711
        ...
        /// <summary>Gets or sets whether the selected items are still highlighted when focus leaves. Stub in Continuum.Forms.</summary>
        public bool HideSelection { get; set; }

        /// <summary>Gets or sets whether labels can be edited in place. Stub in Continuum.Forms.</summary>
        public bool LabelEdit { get; set; }

        /// <summary>Gets or sets whether item labels wrap. Stub in Continuum.Forms.</summary>
        public bool LabelWrap { get; set; } = true;

        /// <summary>Gets or sets whether hover-selection is enabled. Stub in Continuum.Forms.</summary>
        public bool HoverSelection { get; set; }

        /// <summary>Gets or sets whether items can be scrolled. Stub in Continuum.Forms.</summary>
        public bool Scrollable { get; set; } = true;

        /// <summary>Gets or sets whether item tooltips are shown. Stub in Continuum.Forms.</summary>
        public bool ShowItemToolTips { get; set; }

        /// <summary>Gets or sets the virtual mode (no real items, populated via events). Stub in Continuum.Forms.</summary>
        public bool VirtualMode { get; set; }

        /// <summary>Gets or sets the number of virtual list items when VirtualMode is true. Stub in Continuum.Forms.</summary>
        public int VirtualListSize { get; set; }

        /// <summary>Raised when virtual mode items need to be retrieved. Stub in Continuum.Forms.</summary>
        public event EventHandler<RetrieveVirtualItemEventArgs>? RetrieveVirtualItem { add { } remove { } }

        /// <summary>Raised when virtual items need to be cached. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the state image list uses a compatible image behavior. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets or sets whether items are arranged in topdown order. Stub in Continuum.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    public class ColumnHeader
    {
        ...
        /// <summary>Adjusts the column width based on the specified sizing mode. Stub in Continuum.Forms.</summary>
        public void AutoResize (ColumnHeaderAutoResizeStyle headerAutoResize) { }

        /// <summary>Gets or sets the index of the image for this column header. Stub in Continuum.Forms.</summary>
        public int ImageIndex { get; set; } = -1;

        /// <summary>Gets or sets the key of the image for this column header. Stub in Continuum.Forms.</summary>
