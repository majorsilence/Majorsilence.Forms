...
#pragma warning disable CA1416
        public MenuItem (string text, Continuum.Drawing.Image? image, EventHandler<MouseEventArgs>? onClick = null)
        {
            Text = text;
            Image = image;
            Click += onClick;
...
#pragma warning restore CA1416
        ...
        /// <summary>
        /// Gets or sets an image to be displayed on the menu item. Accepts <see cref="Continuum.Drawing.Image"/> for WinForms compatibility.
        /// </summary>
#pragma warning disable CA1416
...
#pragma warning restore CA1416
        ...
        /// <summary>Gets or sets whether this is the default item. Stub in Continuum.Forms.</summary>
        public bool DefaultItem { get; set; }

        /// <summary>Gets or sets whether the item is drawn by the owner. Stub in Continuum.Forms.</summary>
        public bool OwnerDraw { get; set; }

        /// <summary>Gets or sets whether the item appears as a radio button when checked. Stub in Continuum.Forms.</summary>
        public bool RadioCheck { get; set; }

        /// <summary>Gets or sets whether the shortcut key is shown in the label. Stub in Continuum.Forms.</summary>
        public bool ShowShortcut { get; set; } = true;

        /// <summary>Gets or sets the merge order for menu merging. Stub in Continuum.Forms.</summary>
        public int MergeOrder { get; set; }

        /// <summary>Gets or sets the tag object. Stub in Continuum.Forms.</summary>
