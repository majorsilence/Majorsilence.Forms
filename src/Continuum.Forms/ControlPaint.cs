...
namespace Continuum.Forms
{
    ...
    public static class ControlPaint
    {
        ...
        // --- WinForms compatibility overloads taking Continuum.Forms.Graphics ---
        ...
        /// <summary>Draws a focus rectangle using foreground and background colors. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a 3D border around a rectangle. Stub in Continuum.Forms.</summary>
        public static void DrawBorder3D (Graphics graphics, Rectangle rectangle) { }

        /// <summary>Draws a 3D border with the specified style. Stub in Continuum.Forms.</summary>
        public static void DrawBorder3D (Graphics graphics, Rectangle rectangle, Border3DStyle style) { }

        /// <summary>Draws a border around a rectangle. Stub in Continuum.Forms.</summary>
        public static void DrawBorder (Graphics graphics, Rectangle bounds, System.Drawing.Color color, ButtonBorderStyle style) { }

        /// <summary>Draws a border with different style on each side. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a button control. Stub in Continuum.Forms.</summary>
        public static void DrawButton (Graphics graphics, Rectangle rectangle, ButtonState state) { }

        /// <summary>Draws a button control using x/y/width/height. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a standard check box. Stub in Continuum.Forms.</summary>
        public static void DrawCheckBox (Graphics graphics, Rectangle rectangle, ButtonState state) { }

        /// <summary>Draws a check box using x/y/width/height. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a combo box drop-down button. Stub in Continuum.Forms.</summary>
        public static void DrawComboButton (Graphics graphics, Rectangle rectangle, ButtonState state) { }

        /// <summary>Draws a combo box button using x/y/width/height. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a menu glyph. Stub in Continuum.Forms.</summary>
        public static void DrawMenuGlyph (Graphics graphics, Rectangle rectangle, MenuGlyph glyph) { }

        /// <summary>Draws a radio button. Stub in Continuum.Forms.</summary>
        public static void DrawRadioButton (Graphics graphics, Rectangle rectangle, ButtonState state) { }

        /// <summary>Draws a scroll button. Stub in Continuum.Forms.</summary>
        public static void DrawScrollButton (Graphics graphics, Rectangle rectangle, ScrollButton button, ButtonState state) { }

        /// <summary>Draws a size grip. Stub in Continuum.Forms.</summary>
        public static void DrawSizeGrip (Graphics graphics, System.Drawing.Color backColor, Rectangle bounds) { }

        /// <summary>Draws a size grip using x/y/width/height. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Draws a string in its disabled/grayed state. Stub in Continuum.Forms.</summary>
        public static void DrawStringDisabled (Graphics graphics, string s, Continuum.Drawing.Font font, System.Drawing.Color color, RectangleF layoutRectangle, Continuum.Drawing.StringFormat? format) { }

#pragma warning disable CA1416
        /// <summary>Draws a string at the specified coordinates. Stub in Continuum.Forms.</summary>
        public static void DrawString (Graphics graphics, string s, Continuum.Drawing.Font font, System.Drawing.Color color, int x, int y)
        {
            using var brush = new Continuum.Drawing.SolidBrush (color);
            graphics.DrawString (s, font, brush, x, y);
        }

        /// <summary>Draws a string within the specified rectangle. Stub in Continuum.Forms.</summary>
        public static void DrawString (Graphics graphics, string s, Continuum.Drawing.Font font, System.Drawing.Color color, Rectangle layoutRectangle)
        {
            using var brush = new Continuum.Drawing.SolidBrush (color);
        ...
        /// <summary>Draws a string within the specified RectangleF with a StringFormat. Stub in Continuum.Forms.</summary>
        public static void DrawString (Graphics graphics, string s, Continuum.Drawing.Font font, System.Drawing.Color color, System.Drawing.RectangleF layoutRectangle, Continuum.Drawing.StringFormat format)
        {
            using var brush = new Continuum.Drawing.SolidBrush (color);
