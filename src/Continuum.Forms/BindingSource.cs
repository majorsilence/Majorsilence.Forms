...
namespace Continuum.Forms
{
    ...
    public class BindingSource : Component, IList
    {
        ...
        /// <summary>Gets or sets whether ListChanged events are raised during bulk operations. Stub in Continuum.Forms.</summary>
        public bool RaiseListChangedEvents { get; set; } = true;

        /// <summary>Raised when the DataSource property changes. Stub in Continuum.Forms.</summary>
        public event EventHandler? DataSourceChanged { add { } remove { } }

        /// <summary>Raised when the DataMember property changes. Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Adds a new item to the underlying list. Stub in Continuum.Forms.</summary>
#pragma warning disable CA1711
        public object? AddNew () { _list.Add (null); return null; }
#pragma warning restore CA1711

        /// <summary>Removes the current item from the list. Stub in Continuum.Forms.</summary>
        public void RemoveCurrent () { if (Position >= 0 && Position < _list.Count) _list.RemoveAt (Position); }

        /// <summary>Commits the pending edit. Stub in Continuum.Forms.</summary>
        public void EndEdit () { }

        /// <summary>Cancels the pending edit. Stub in Continuum.Forms.</summary>
        public void CancelEdit () { }

        /// <summary>Raises the ListChanged event. Stub in Continuum.Forms.</summary>
        public void ResetItem (int itemIndex) { }

        /// <summary>Returns the index of the item with the given property value. Stub in Continuum.Forms.</summary>
        public int Find (string propertyName, object key) => -1;

        /// <summary>Returns whether the list allows new items. Stub in Continuum.Forms.</summary>
        public bool AllowNew { get; set; } = true;

        /// <summary>Returns whether the list allows edits. Stub in Continuum.Forms.</summary>
        public bool AllowEdit { get; set; } = true;

        /// <summary>Returns whether the list allows items to be removed. Stub in Continuum.Forms.</summary>
