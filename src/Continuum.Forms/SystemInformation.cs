...
namespace Continuum.Forms
{
    ...
    public static class SystemInformation
    {
        ...
        /// <summary>Gets whether the mouse is present. Always true in Continuum.Forms.</summary>
        ...
        /// <summary>Gets whether a slow machine flag is set. Always false in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the bounds of the virtual screen (combined area of all monitors). Stub in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the current screen orientation. Stub in Continuum.Forms.</summary>
    ...
    {
        /// <summary>Gets the current battery charge status. Always High in Continuum.Forms.</summary>
        ...
        /// <summary>Gets the current power line status. Always Online in Continuum.Forms.</summary>
