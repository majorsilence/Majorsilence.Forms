...
namespace Continuum.Forms
{
    ...
    public class Cursor : IDisposable
    {
        ...
        /// <summary>Gets or sets the current mouse cursor. Stub in Continuum.Forms.</summary>
        public static Cursor? Current { get; set; }

        /// <summary>Hides the cursor. Stub in Continuum.Forms.</summary>
        public static void Hide () { }

        /// <summary>Shows the cursor. Stub in Continuum.Forms.</summary>
        public static void Show () { }

        /// <summary>Gets or sets the cursor's position in screen coordinates. Stub in Continuum.Forms.</summary>
        public static System.Drawing.Point Position { get; set; }

        /// <summary>Gets or sets whether the cursor is clipped to a rectangle. Stub in Continuum.Forms.</summary>
