...
namespace Modern.Forms
{
    ...
    /// In Modern.Forms, text measurement delegates to <see cref="TextMeasurer"/>.
    /// </summary>
    public static class TextRenderer
    {
        ...
        /// <summary>
        /// Draws the specified text on the canvas at the given location. Stub in Modern.Forms.
        /// </summary>
...
#pragma warning disable CA1416
        /// <summary>Measures text using a Modern.Drawing.Font. Delegates to SKTypeface approximation.</summary>
        public static Size MeasureText (string text, Modern.Drawing.Font font)
        {
            var tf = SKTypeface.FromFamilyName (font.Name) ?? Theme.UIFont;
            return MeasureText (text, tf, (int)font.SizeInPoints);
        }

        /// <summary>Measures text using a Modern.Drawing.Font with size constraints.</summary>
        public static Size MeasureText (string text, Modern.Drawing.Font font, Size proposedSize)
        {
            var tf = SKTypeface.FromFamilyName (font.Name) ?? Theme.UIFont;
            return MeasureText (text, tf, proposedSize, (int)font.SizeInPoints);
        }

        /// <summary>Draws text at the given point using a Modern.Drawing.Font. Stub in Modern.Forms.</summary>
        public static void DrawText (Graphics g, string text, Modern.Drawing.Font font, Rectangle bounds, System.Drawing.Color foreColor)
        {
            using var brush = new Modern.Drawing.SolidBrush (foreColor);
            g.DrawString (text, font, brush, new RectangleF (bounds.X, bounds.Y, bounds.Width, bounds.Height));
        }

        /// <summary>Draws text at the given point using a Modern.Drawing.Font with flags. Stub in Modern.Forms.</summary>
        public static void DrawText (Graphics g, string text, Modern.Drawing.Font font, Rectangle bounds, System.Drawing.Color foreColor, TextFormatFlags flags)
            => DrawText (g, text, font, bounds, foreColor);

        /// <summary>Draws text at the specified point using a Modern.Drawing.Font.</summary>
        public static void DrawText (Graphics g, string text, Modern.Drawing.Font font, System.Drawing.Point pt, System.Drawing.Color foreColor)
            => DrawText (g, text, font, new Rectangle (pt.X, pt.Y, 0, 0), foreColor);

        /// <summary>Draws text at the specified point with flags using a Modern.Drawing.Font.</summary>
        public static void DrawText (Graphics g, string text, Modern.Drawing.Font font, System.Drawing.Point pt, System.Drawing.Color foreColor, TextFormatFlags flags)
            => DrawText (g, text, font, new Rectangle (pt.X, pt.Y, 0, 0), foreColor);
