namespace Modern.Forms
{
    ...
    /// In Modern.Forms, UserControl is an alias for Panel with full tab-stop support.
    /// </summary>
    public class UserControl : Panel
    {
        ...
        /// <summary>Gets or sets how the UserControl validates its children. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Validates all child controls by triggering Validating/Validated events. Stub in Modern.Forms.</summary>
    ...
    /// In Modern.Forms this is an alias for Panel.
    /// </summary>
    public class ContainerControl : Panel
    {
        ...
        /// <summary>Gets or sets how the container validates its children. Stub in Modern.Forms.</summary>
        public AutoValidate AutoValidate { get; set; } = AutoValidate.EnablePreventFocusChange;

        /// <summary>Gets or sets the auto-scale mode. Stub in Modern.Forms.</summary>
        public AutoScaleMode AutoScaleMode { get; set; } = AutoScaleMode.Font;

        /// <summary>Gets or sets the auto-scale dimensions. Stub in Modern.Forms.</summary>
        public System.Drawing.SizeF AutoScaleDimensions { get; set; }

        /// <summary>Validates all children. Stub in Modern.Forms.</summary>
        public bool ValidateChildren () => true;
    }
}
