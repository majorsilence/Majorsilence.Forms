...
namespace Modern.Forms
{
    ...
    /// In Modern.Forms, dialogs are implemented as Form subclasses; this class provides compatibility.
    /// </summary>
    public abstract class CommonDialog : Component
    {
        /// <summary>Gets or sets an arbitrary object that provides additional data about the dialog. Stub in Modern.Forms.</summary>
