...
namespace Modern.Forms
{
    ...
    public class PropertyGrid : ScrollableControl
    {
        ...
        /// <summary>Expands all categories. Stub in Modern.Forms.</summary>
        public void ExpandAllGridItems () { }

        /// <summary>Collapses all categories. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the help panel is visible. Stub in Modern.Forms.</summary>
        public bool HelpVisible { get; set; } = true;

        /// <summary>Gets or sets whether the toolbar is visible. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Gets the currently selected grid item. Stub in Modern.Forms — returns null.</summary>
        public object? SelectedGridItem => null;

        /// <summary>Gets or sets whether commands pane is shown when available. Stub in Modern.Forms.</summary>
