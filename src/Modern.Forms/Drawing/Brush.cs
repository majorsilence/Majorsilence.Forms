...
namespace Modern.Drawing
{
    ...
    public abstract class Brush : IDisposable
    {
        ...
        /// <summary>Releases the resources used by this brush. No-op in Modern.Drawing.</summary>
    ...
    /// <summary>
    /// A brush that fills with a hatch pattern. Stub in Modern.Forms — fills with the foreground color.
    /// </summary>
