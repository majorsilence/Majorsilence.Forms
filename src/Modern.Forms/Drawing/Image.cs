...
namespace Modern.Drawing
{
    ...
    public abstract class Image : IDisposable, ICloneable
    {
        ...
        /// <summary>Gets the pixel format of this image. Always 32bpp ARGB in Modern.Drawing.</summary>
    ...
    public sealed class Bitmap : Image
    {
        ...
        /// <summary>Makes the default transparent color transparent. No-op in Modern.Drawing.</summary>
        public void MakeTransparent () { }

        /// <summary>Makes the specified color transparent. No-op in Modern.Drawing.</summary>
        ...
        /// <summary>Returns a GDI icon handle. Returns IntPtr.Zero in Modern.Drawing.</summary>
