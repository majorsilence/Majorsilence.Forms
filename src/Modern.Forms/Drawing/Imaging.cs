...
namespace Modern.Drawing.Imaging
{
    /// <summary>
    ...
    /// <summary>
    /// Specifies the pixel format of an image. Modern.Drawing always stores 32bpp ARGB; the other
    ...
    /// <summary>Specifies the access mode used when locking bitmap bits. Stub in Modern.Drawing.</summary>
