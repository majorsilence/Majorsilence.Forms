...
using Modern.Drawing.Drawing2D;
using Modern.Drawing.Text;
using SkiaSharp;
...
namespace Modern.Forms
{
    ...
    public sealed class Graphics : IDisposable
    {
        ...
        /// <summary>Creates a Graphics object for drawing on the specified Modern.Drawing.Image.</summary>
        public static Graphics FromImage (Modern.Drawing.Image image)
        {
        ...
        /// <summary>Creates a Graphics object for the specified window handle. Returns a no-op instance in Modern.Forms.</summary>
        public static Graphics FromHwnd (IntPtr hwnd) => new Graphics ();

        /// <summary>Creates a Graphics object from a device context handle. Returns a no-op instance in Modern.Forms.</summary>
        ...
        /// <summary>Measures the string with a Modern.Drawing.Font (maps to SKTypeface at the font's size).</summary>
        public SizeF MeasureString (string text, Modern.Drawing.Font font)
        {
        ...
        /// <summary>Measures the string with a Modern.Drawing.Font, constrained to a size.</summary>
        public SizeF MeasureString (string text, Modern.Drawing.Font font, SizeF layoutArea)
        {
            if (string.IsNullOrEmpty (text) || font is null) return SizeF.Empty;
            var face = SKTypeface.FromFamilyName (font.FontFamily.Name, font.Bold ? SKFontStyle.Bold : SKFontStyle.Normal);
        ...
        /// <summary>Measures the string with a Modern.Drawing.Font and StringFormat (format is ignored).</summary>
        public SizeF MeasureString (string text, Modern.Drawing.Font font, Modern.Drawing.StringFormat? format)
            => MeasureString (text, font);

        /// <summary>Measures the string with a Modern.Drawing.Font, constrained to int width (StringFormat ignored).</summary>
        public SizeF MeasureString (string text, Modern.Drawing.Font font, int width, Modern.Drawing.StringFormat? format)
        {
            if (string.IsNullOrEmpty (text) || font is null) return SizeF.Empty;
            var face = SKTypeface.FromFamilyName (font.FontFamily.Name, font.Bold ? SKFontStyle.Bold : SKFontStyle.Normal);
        ...
        /// <summary>Measures the string with a Modern.Drawing.Font, constrained to SizeF (StringFormat ignored).</summary>
        public SizeF MeasureString (string text, Modern.Drawing.Font font, SizeF layoutArea, Modern.Drawing.StringFormat? format)
            => MeasureString (text, font, layoutArea);

        // --- Transform stubs ---

        /// <summary>Gets the dots-per-inch (always 96 in Modern.Forms).</summary>
        ...
        /// <summary>Gets the visible clip bounds. Alias for ClipBounds in Modern.Forms.</summary>
        public RectangleF VisibleClipBounds => ClipBounds;

        /// <summary>Gets whether the visible clip region is empty. Always false in Modern.Forms.</summary>
        public bool IsVisibleClipEmpty => false;

        /// <summary>Gets or sets the unit of measure for page coordinates. Stub in Modern.Forms — always Pixel.</summary>
        public Modern.Drawing.GraphicsUnit PageUnit { get; set; } = Modern.Drawing.GraphicsUnit.Pixel;

        /// <summary>Gets or sets the scaling factor for page-to-world coordinates. Stub in Modern.Forms.</summary>
        public float PageScale { get; set; } = 1f;

        /// <summary>Stub: saves the current graphics state.</summary>
        public Modern.Drawing.Drawing2D.GraphicsState Save () { _canvas?.Save (); return null!; }

        /// <summary>Stub: restores a previously saved state.</summary>
        public void Restore (Modern.Drawing.Drawing2D.GraphicsState state) => _canvas?.Restore ();

        /// <summary>Gets or sets the smoothing mode. Stub in Modern.Forms (always anti-aliased).</summary>
        public SmoothingMode SmoothingMode { get; set; } = SmoothingMode.Default;

        /// <summary>Gets or sets the interpolation mode. Stub in Modern.Forms.</summary>
        public InterpolationMode InterpolationMode { get; set; } = InterpolationMode.Default;

        /// <summary>Gets or sets the text rendering hint. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Text.TextRenderingHint TextRenderingHint { get; set; } = Modern.Drawing.Text.TextRenderingHint.SystemDefault;

        /// <summary>Gets or sets the compositing quality. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Drawing2D.CompositingQuality CompositingQuality { get; set; } = Modern.Drawing.Drawing2D.CompositingQuality.Default;

        /// <summary>Gets or sets the pixel offset mode. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Drawing2D.PixelOffsetMode PixelOffsetMode { get; set; } = Modern.Drawing.Drawing2D.PixelOffsetMode.Default;

        /// <summary>Gets or sets the compositing mode. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Drawing2D.CompositingMode CompositingMode { get; set; } = Modern.Drawing.Drawing2D.CompositingMode.SourceOver;
        ...
        /// <summary>Intersects the clipping region with the given rectangle. Stub in Modern.Forms.</summary>
        public void IntersectClip (Rectangle rect) => SetClip (rect);

        /// <summary>Intersects the clipping region with the given rectangle. Stub in Modern.Forms.</summary>
        public void IntersectClip (RectangleF rect) => SetClip (rect);

        /// <summary>Gets or sets the clipping region. Stub in Modern.Forms — always null.</summary>
        public Modern.Drawing.Region? Clip { get => null; set { } }

        /// <summary>Excludes a rectangle from the clipping region. Stub in Modern.Forms.</summary>
        public void ExcludeClip (Rectangle rect) { }

        /// <summary>Excludes a region from the clipping region. Stub in Modern.Forms.</summary>
        public void ExcludeClip (Modern.Drawing.Region region) { }

        /// <summary>Returns whether the specified point is within the clipping region. Always returns true in Modern.Forms.</summary>
        public bool IsVisible (Point point) => true;

        /// <summary>Returns whether the specified rectangle is within the clipping region. Always returns true in Modern.Forms.</summary>
        public bool IsVisible (Rectangle rect) => true;

        /// <summary>Returns whether the specified rectangle is within the clipping region. Always returns true in Modern.Forms.</summary>
        public bool IsVisible (RectangleF rect) => true;

        /// <summary>Applies a matrix transform to the current transform. Stub in Modern.Forms.</summary>
        public void MultiplyTransform (Modern.Drawing.Drawing2D.Matrix matrix) { }

        /// <summary>Applies a matrix transform to the current transform. Stub in Modern.Forms.</summary>
        public void MultiplyTransform (Modern.Drawing.Drawing2D.Matrix matrix, Modern.Drawing.Drawing2D.MatrixOrder order) { }

        // --- Drawing operations (Skia-backed when canvas is available) ---

        /// <summary>Draws a Modern.Drawing.Icon at the specified location. Converts to bitmap internally.</summary>
#pragma warning disable CA1416
        public void DrawIcon (Modern.Drawing.Icon icon, int x, int y)
        {
        ...
        /// <summary>Draws a Modern.Drawing.Icon stretched to fill the destination rectangle.</summary>
        public void DrawIcon (Modern.Drawing.Icon icon, Rectangle targetRect)
        {
            if (icon == null || _canvas == null) return;
            using var bmp = icon.ToBitmap ();
            using var skBmp = bmp.ToSKBitmap ();
        ...
        /// <summary>Draws an unscaled Modern.Drawing.Icon at the specified location.</summary>
        public void DrawIconUnstretched (Modern.Drawing.Icon icon, Rectangle targetRect) => DrawIcon (icon, targetRect.X, targetRect.Y);

        /// <summary>Returns the device context handle. Returns IntPtr.Zero in Modern.Forms (stub).</summary>
        public IntPtr GetHdc () => IntPtr.Zero;

        /// <summary>Releases the device context handle. No-op in Modern.Forms (stub).</summary>
        public void ReleaseHdc (IntPtr hdc) { }

        /// <summary>Releases the device context handle. No-op in Modern.Forms (stub).</summary>
        public void ReleaseHdc () { }

        /// <summary>Copies the contents of the screen to this Graphics surface. Stub in Modern.Forms.</summary>
        ...
        private static SKColor BrushColor (Modern.Drawing.Brush brush)
            => brush is Modern.Drawing.SolidBrush sb ? ToSKColor (sb.Color) : SKColors.Black;
        private static float PenWidth (Modern.Drawing.Pen pen) => pen.Width;
        private static SKColor PenColor (Modern.Drawing.Pen pen) => ToSKColor (pen.Color);
        ...
        /// <summary>Fills a rectangle using a Modern.Drawing.Brush.</summary>
        public void FillRectangle (Modern.Drawing.Brush brush, Rectangle rect)
        {
        ...
        /// <summary>Fills a rectangle using a Modern.Drawing.Brush.</summary>
        public void FillRectangle (Modern.Drawing.Brush brush, RectangleF rect)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = BrushColor (brush), Style = SKPaintStyle.Fill };
            _canvas.DrawRect (new SKRect (rect.Left, rect.Top, rect.Right, rect.Bottom), paint);
        ...
        /// <summary>Fills a rectangle using a Modern.Drawing.Brush.</summary>
        public void FillRectangle (Modern.Drawing.Brush brush, float x, float y, float width, float height)
            => FillRectangle (brush, new RectangleF (x, y, width, height));

        /// <summary>Fills a rectangle using a Modern.Drawing.Brush.</summary>
        public void FillRectangle (Modern.Drawing.Brush brush, int x, int y, int width, int height)
            => FillRectangle (brush, new Rectangle (x, y, width, height));

        /// <summary>Draws a rectangle outline using a Modern.Drawing.Pen.</summary>
        public void DrawRectangle (Modern.Drawing.Pen pen, Rectangle rect)
        {
            if (_canvas is null) return;
        ...
        /// <summary>Draws a rectangle outline using a Modern.Drawing.Pen.</summary>
        public void DrawRectangle (Modern.Drawing.Pen pen, int x, int y, int width, int height)
            => DrawRectangle (pen, new Rectangle (x, y, width, height));

        /// <summary>Draws a line using a Modern.Drawing.Pen.</summary>
        public void DrawLine (Modern.Drawing.Pen pen, Point p1, Point p2)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
        ...
        /// <summary>Draws a line using a Modern.Drawing.Pen.</summary>
        public void DrawLine (Modern.Drawing.Pen pen, int x1, int y1, int x2, int y2)
            => DrawLine (pen, new Point (x1, y1), new Point (x2, y2));

        /// <summary>Draws a line using a Modern.Drawing.Pen.</summary>
        public void DrawLine (Modern.Drawing.Pen pen, PointF p1, PointF p2)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            _canvas.DrawLine (p1.X, p1.Y, p2.X, p2.Y, paint);
        ...
        public void DrawRectangle (Modern.Drawing.Pen pen, float x, float y, float width, float height)
            => DrawRectangle (pen, new Rectangle ((int)x, (int)y, (int)width, (int)height));

        /// <summary>Draws a rectangle with a RectangleF.</summary>
        public void DrawRectangle (Modern.Drawing.Pen pen, RectangleF rect)
            => DrawRectangle (pen, new Rectangle ((int)rect.X, (int)rect.Y, (int)rect.Width, (int)rect.Height));

        /// <summary>Draws an arc.</summary>
        public void DrawArc (Modern.Drawing.Pen pen, Rectangle rect, float startAngle, float sweepAngle)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
        ...
        public void DrawArc (Modern.Drawing.Pen pen, float x, float y, float width, float height, float startAngle, float sweepAngle)
            => DrawArc (pen, new Rectangle ((int)x, (int)y, (int)width, (int)height), startAngle, sweepAngle);

        /// <summary>Draws a pie section.</summary>
        public void DrawPie (Modern.Drawing.Pen pen, Rectangle rect, float startAngle, float sweepAngle)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            using var path = new SKPath ();
        ...
        public void FillPie (Modern.Drawing.Brush brush, Rectangle rect, float startAngle, float sweepAngle)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = BrushColor (brush), Style = SKPaintStyle.Fill };
            using var path = new SKPath ();
        ...
        public void FillPie (Modern.Drawing.Brush brush, float x, float y, float width, float height, float startAngle, float sweepAngle)
        ...
        public void DrawBezier (Modern.Drawing.Pen pen, PointF pt1, PointF pt2, PointF pt3, PointF pt4)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            using var path = new SKPath ();
        ...
        public void DrawBezier (Modern.Drawing.Pen pen, Point pt1, Point pt2, Point pt3, Point pt4)
        ...
        public void DrawBeziers (Modern.Drawing.Pen pen, PointF[] points)
        {
        ...
        public void DrawBeziers (Modern.Drawing.Pen pen, Point[] points)
        {
            if (_canvas is null || points.Length < 4) return;
            for (int i = 0; i + 3 < points.Length; i += 3)
                DrawBezier (pen, points[i], points[i + 1], points[i + 2], points[i + 3]);
        ...
        public void DrawCurve (Modern.Drawing.Pen pen, PointF[] points)
        {
        ...
        public void DrawCurve (Modern.Drawing.Pen pen, Point[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            using var path = new SKPath ();
        ...
        /// <summary>Fills an ellipse using a Modern.Drawing.Brush.</summary>
        public void FillEllipse (Modern.Drawing.Brush brush, Rectangle rect)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = BrushColor (brush), Style = SKPaintStyle.Fill };
        ...
        /// <summary>Fills an ellipse using a Modern.Drawing.Brush.</summary>
        public void FillEllipse (Modern.Drawing.Brush brush, float x, float y, float width, float height)
            => FillEllipse (brush, new Rectangle ((int)x, (int)y, (int)width, (int)height));

        /// <summary>Draws an ellipse outline using a Modern.Drawing.Pen.</summary>
        public void DrawEllipse (Modern.Drawing.Pen pen, Rectangle rect)
        {
            if (_canvas is null) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            _canvas.DrawOval (new SKRect (rect.Left, rect.Top, rect.Right, rect.Bottom), paint);
        ...
        /// <summary>Draws an ellipse outline using a Modern.Drawing.Pen (RectangleF overload).</summary>
        public void DrawEllipse (Modern.Drawing.Pen pen, RectangleF rect)
            => DrawEllipse (pen, new Rectangle ((int)rect.X, (int)rect.Y, (int)rect.Width, (int)rect.Height));

        /// <summary>Fills an ellipse using a Modern.Drawing.Brush (RectangleF overload).</summary>
        public void FillEllipse (Modern.Drawing.Brush brush, RectangleF rect)
        ...
        public void FillPolygon (Modern.Drawing.Brush brush, Point[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            var path = new SKPath ();
            path.MoveTo (points[0].X, points[0].Y);
        ...
        public void DrawPolygon (Modern.Drawing.Pen pen, Point[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            var path = new SKPath ();
            path.MoveTo (points[0].X, points[0].Y);
        ...
        public void DrawPolygon (Modern.Drawing.Pen pen, PointF[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            var path = new SKPath ();
            path.MoveTo (points[0].X, points[0].Y);
        ...
        public void FillPolygon (Modern.Drawing.Brush brush, PointF[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            var path = new SKPath ();
            path.MoveTo (points[0].X, points[0].Y);
        ...
        public void DrawLines (Modern.Drawing.Pen pen, Point[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
        ...
        public void DrawLines (Modern.Drawing.Pen pen, PointF[] points)
        {
            if (_canvas is null || points.Length < 2) return;
            using var paint = new SKPaint { Color = PenColor (pen), Style = SKPaintStyle.Stroke, StrokeWidth = PenWidth (pen) };
            for (int i = 1; i < points.Length; i++)
        ...
        public void DrawRectangles (Modern.Drawing.Pen pen, Rectangle[] rects)
        {
            foreach (var r in rects) DrawRectangle (pen, r);
        }

        /// <summary>Draws a series of rectangles using floating-point coordinates.</summary>
        public void DrawRectangles (Modern.Drawing.Pen pen, RectangleF[] rects)
        {
        ...
        public void FillRectangles (Modern.Drawing.Brush brush, Rectangle[] rects)
        {
        ...
        public void FillRectangles (Modern.Drawing.Brush brush, RectangleF[] rects)
        {
            foreach (var r in rects) FillRectangle (brush, r);
        }

        /// <summary>Draws a string with the given Modern.Drawing.Font and Brush.</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, float x, float y)
        {
        ...
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, PointF point)
            => DrawString (text, font, brush, point.X, point.Y);

        /// <summary>Draws a string at the given Point.</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, Point point)
            => DrawString (text, font, brush, point.X, point.Y);

        /// <summary>Draws a string within the specified rectangle.</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, RectangleF bounds)
        {
            if (_canvas is null || string.IsNullOrEmpty (text)) return;
            _canvas.Save ();
        ...
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, RectangleF bounds, Modern.Drawing.StringFormat? format)
            => DrawString (text, font, brush, bounds);

        /// <summary>Draws a string within the specified rectangle.</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, RectangleF bounds, object? format)
            => DrawString (text, font, brush, bounds);

        /// <summary>Draws a string at the given PointF (StringFormat is ignored).</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, PointF point, Modern.Drawing.StringFormat? format)
            => DrawString (text, font, brush, point.X, point.Y);

        /// <summary>Draws a string at the given float coordinates (StringFormat is ignored).</summary>
        public void DrawString (string text, Modern.Drawing.Font font, Modern.Drawing.Brush brush, float x, float y, Modern.Drawing.StringFormat? format)
        ...
        public void DrawImage (SKBitmap image, Rectangle destRect, Rectangle srcRect, Modern.Drawing.GraphicsUnit srcUnit)
        {
            if (_canvas is null || image is null) return;
        ...
        /// <summary>Draws a Modern.Drawing.Image at the specified location.</summary>
#pragma warning disable CA1416
        public void DrawImage (Modern.Drawing.Image image, int x, int y)
        {
            using var bmp = image?.ToSKBitmap ();
            if (bmp != null) DrawImage (bmp, x, y);
        }

        /// <summary>Draws a Modern.Drawing.Image at the specified location and size (int overload).</summary>
        public void DrawImage (Modern.Drawing.Image image, int x, int y, int width, int height)
            => DrawImage (image, new Rectangle (x, y, width, height));

        /// <summary>Draws a Modern.Drawing.Image scaled to fill the destination rectangle.</summary>
        public void DrawImage (Modern.Drawing.Image image, Rectangle destRect)
        {
            using var bmp = image?.ToSKBitmap ();
        ...
        /// <summary>Draws a Modern.Drawing.Image scaled to fill the destination rectangle.</summary>
        public void DrawImage (Modern.Drawing.Image image, RectangleF destRect)
            => DrawImage (image, Rectangle.Round (destRect));

        /// <summary>Draws a Modern.Drawing.Image at (x,y) scaled to (width,height).</summary>
        public void DrawImage (Modern.Drawing.Image image, float x, float y, float width, float height)
            => DrawImage (image, new Rectangle ((int)x, (int)y, (int)width, (int)height));

        /// <summary>Draws a Modern.Drawing.Bitmap at the specified location.</summary>
        public void DrawImage (Modern.Drawing.Bitmap bitmap, int x, int y) => DrawImage ((Modern.Drawing.Image)bitmap, x, y);

        /// <summary>Draws a Modern.Drawing.Bitmap scaled to fill the destination rectangle.</summary>
        public void DrawImage (Modern.Drawing.Bitmap bitmap, Rectangle destRect) => DrawImage ((Modern.Drawing.Image)bitmap, destRect);

        /// <summary>Draws a portion of a Modern.Drawing.Image to the destination rectangle.</summary>
        public void DrawImage (Modern.Drawing.Image image, Rectangle destRect, Rectangle srcRect, Modern.Drawing.GraphicsUnit srcUnit)
        {
            using var bmp = image?.ToSKBitmap ();
            if (bmp != null) DrawImage (bmp, destRect, srcRect, srcUnit);
        }

        /// <summary>Draws a Modern.Drawing.Image unscaled at a point.</summary>
        public void DrawImageUnscaled (Modern.Drawing.Image image, int x, int y) => DrawImage (image, x, y);

        /// <summary>Draws a Modern.Drawing.Image unscaled at a point.</summary>
        public void DrawImageUnscaled (Modern.Drawing.Image image, Rectangle rect) => DrawImage (image, rect);
#pragma warning restore CA1416
        ...
        public void RotateTransform (float angle, Modern.Drawing.Drawing2D.MatrixOrder order)
            => _canvas?.RotateDegrees (angle);

        /// <summary>Gets or sets the current world transformation matrix. Stub — setting is ignored.</summary>
#pragma warning disable CA1416
        public Modern.Drawing.Drawing2D.Matrix Transform {
            get => new Modern.Drawing.Drawing2D.Matrix ();
            set { }
        }
#pragma warning restore CA1416

        /// <summary>Draws a Modern.Drawing.Drawing2D.GraphicsPath outline using the specified pen.</summary>
#pragma warning disable CA1416
        public void DrawPath (Modern.Drawing.Pen pen, Modern.Drawing.Drawing2D.GraphicsPath path)
        {
            ...
            using var paint = new SKPaint {
                ...
                IsAntialias = SmoothingMode != Modern.Drawing.Drawing2D.SmoothingMode.None
            };
        ...
        /// <summary>Fills the interior of a Modern.Drawing.Drawing2D.GraphicsPath using the specified brush.</summary>
        public void FillPath (Modern.Drawing.Brush brush, Modern.Drawing.Drawing2D.GraphicsPath path)
        {
            if (_canvas is null || path is null) return;

            SKColor fillColor;

            if (brush is Modern.Drawing.SolidBrush sb)
...
#pragma warning restore CA1416
        ...
        /// <summary>Sets the clipping region of this Graphics to the intersection of the current clip and a Modern.Drawing.Drawing2D.GraphicsPath.</summary>
#pragma warning disable CA1416
        public void SetClip (Modern.Drawing.Drawing2D.GraphicsPath path)
        {
            if (_canvas is null || path is null) return;
...
#pragma warning restore CA1416
        ...
        /// <summary>Sets the clipping region to the intersection with an existing region. Stub in Modern.Forms.</summary>
#pragma warning disable CA1416
        public void SetClip (Modern.Drawing.Region region) { }
#pragma warning restore CA1416
