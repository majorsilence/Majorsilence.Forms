namespace Modern.Forms.Printing
{
    ...
    public sealed class PrinterSettings
    {
        ...
        /// <summary>Gets or sets whether this is the default printer. Stub in Modern.Forms.</summary>
        public bool IsDefaultPrinter => true;

        /// <summary>Gets or sets whether the printer settings are valid. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Gets or sets whether the printer supports duplex printing. Stub in Modern.Forms.</summary>
        public bool CanDuplex => false;

        /// <summary>Gets or sets the duplex setting. Stub in Modern.Forms.</summary>
        public Duplex Duplex { get; set; } = Duplex.Simplex;

        /// <summary>Gets or sets the file name when printing to a file. Stub in Modern.Forms.</summary>
        public string PrintFileName { get; set; } = string.Empty;

        /// <summary>Gets the list of installed printers. Stub in Modern.Forms — returns empty collection.</summary>
