...
namespace Modern.Forms
{
    ...
    public class TabControl : Control
    {
        ...
        /// <summary>Gets or sets whether more than one row of tabs can be displayed. Stub in Modern.Forms.</summary>
        public bool Multiline { get; set; }

        /// <summary>Gets or sets the alignment of the tabs. Stub in Modern.Forms (always top).</summary>
        public TabAlignment Alignment { get; set; } = TabAlignment.Top;

        /// <summary>Gets or sets the draw mode for the tabs. Stub in Modern.Forms.</summary>
        public TabDrawMode DrawMode { get; set; } = TabDrawMode.Normal;

        /// <summary>Gets or sets the fixed size of each tab. Stub in Modern.Forms.</summary>
        public System.Drawing.Size ItemSize { get; set; }

        /// <summary>Gets or sets the width of the selected tab padding. Stub in Modern.Forms.</summary>
        public new System.Drawing.Point Padding { get; set; }

        /// <summary>Gets or sets whether tab pages show their tooltips. Stub in Modern.Forms.</summary>
        public bool ShowToolTips { get; set; }

        /// <summary>Gets or sets the visual appearance of the tab control. Stub in Modern.Forms.</summary>
        public TabAppearance Appearance { get; set; } = TabAppearance.Normal;

        /// <summary>Gets or sets whether tabs are highlighted when mouse hovers. Stub in Modern.Forms.</summary>
        public bool HotTrack { get; set; }

        /// <summary>Gets or sets a value indicating whether right-to-left mirror placement is turned on. Stub in Modern.Forms.</summary>
        public bool RightToLeftLayout { get; set; }

        /// <summary>Gets the number of tabs in the tab strip.</summary>
        public int TabCount => TabPages.Count;

        /// <summary>Gets or sets the size mode of the tabs. Stub in Modern.Forms.</summary>
        public TabSizeMode SizeMode { get; set; } = TabSizeMode.Normal;

        /// <summary>Gets the number of tab rows. Always returns 1 in Modern.Forms.</summary>
        ...
        /// <summary>Raised when a tab is drawn (owner-draw mode). Stub in Modern.Forms.</summary>
        public event EventHandler<DrawItemEventArgs>? DrawItem { add { } remove { } }

        /// <summary>Raised before a tab page is selected. Stub in Modern.Forms.</summary>
        public event EventHandler<TabControlCancelEventArgs>? Selecting { add { } remove { } }

        /// <summary>Raised after a tab page is selected. Stub in Modern.Forms.</summary>
        public new event EventHandler<TabControlEventArgs>? Selected { add { } remove { } }

        /// <summary>Raised before a tab page is deselected. Stub in Modern.Forms.</summary>
        public event EventHandler<TabControlCancelEventArgs>? Deselecting { add { } remove { } }

        /// <summary>Raised after a tab page is deselected. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Returns the tab page at the specified client point, or null. Stub in Modern.Forms.</summary>
