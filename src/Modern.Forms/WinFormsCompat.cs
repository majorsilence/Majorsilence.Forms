...
namespace Modern.Forms
{
    ...
    /// Stub in Modern.Forms — all operations are no-ops.
    /// </summary>
    public class NativeWindow
    {
        /// <summary>Gets the handle to the window. Always IntPtr.Zero in Modern.Forms.</summary>
        public IntPtr Handle => IntPtr.Zero;

        /// <summary>Assigns a handle to this NativeWindow. No-op stub in Modern.Forms.</summary>
        public virtual void AssignHandle (IntPtr handle) { }

        /// <summary>Creates a window with the specified creation parameters. No-op stub in Modern.Forms.</summary>
        public virtual void CreateHandle (CreateParams cp) { }

        /// <summary>Destroys the associated window handle. No-op stub in Modern.Forms.</summary>
        public virtual void DestroyHandle () { }

        /// <summary>Releases the associated window handle. No-op stub in Modern.Forms.</summary>
        public virtual void ReleaseHandle () { }

        /// <summary>Processes messages sent to the window. No-op stub in Modern.Forms.</summary>
        protected virtual void WndProc (ref Message m) { }
    }

    /// <summary>Encapsulates the information needed to create a window. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Represents a data binding between a control property and a data source property. Stub in Modern.Forms.</summary>
    public class Binding
    {
        ...
        /// <summary>Gets or sets the format string. Stub in Modern.Forms.</summary>
        public string FormatString { get; set; } = string.Empty;

        /// <summary>Raised when the control value is formatted. Stub in Modern.Forms.</summary>
        public event ConvertEventHandler? Format { add { } remove { } }

        /// <summary>Raised when the data source value is parsed. Stub in Modern.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    /// <summary>Represents the collection of data bindings for a control. Stub in Modern.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    /// <summary>Specifies constants representing accessible events. Stub in Modern.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    /// <summary>A collection of strings used for auto-complete suggestions. Stub in Modern.Forms.</summary>
    ...
    /// In Modern.Forms, this class is called TreeViewItem — TreeNode is an alias for easy migration.
    /// </summary>
    ...
    public static class MessageBox
    {
        ...
        /// <summary>Shows a message box with text, caption, buttons, icon, and default button. Default button is ignored in Modern.Forms.</summary>
        public static DialogResult Show (string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
            => Show (text, caption, buttons, icon);

        /// <summary>Shows a message box with text, caption, buttons, icon, default button, and options. Extras are ignored in Modern.Forms.</summary>
        public static DialogResult Show (string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, MessageBoxOptions options)
            => Show (text, caption, buttons, icon);

        /// <summary>Shows a message box with owner, text, caption, buttons, icon, and default button. Default button is ignored in Modern.Forms.</summary>
        public static DialogResult Show (IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
            => Show (owner, text, caption, buttons, icon);

        /// <summary>Gets or sets the default desktop on which message boxes appear. Stub in Modern.Forms.</summary>
        public static MessageBoxDefaultButton DefaultButton { get; set; } = MessageBoxDefaultButton.Button1;
    }

    /// <summary>Provides options for a MessageBox. Stub in Modern.Forms — options are accepted but ignored.</summary>
    [Flags]
    ...
    public class ToolStripItem : MenuItem
    {
        ...
        /// <summary>
        /// Gets or sets the image displayed on this item. Accepts <see cref="Modern.Drawing.Image"/> for WinForms compatibility.
        /// The converted <see cref="SkiaSharp.SKBitmap"/> is synced to the base class so renderers can access it.
        /// </summary>
#pragma warning disable CA1416
        public new Modern.Drawing.Image? Image {
            get => _toolStripImage;
            set {
...
#pragma warning restore CA1416
        ...
        private Modern.Drawing.Image? _toolStripImage;
        ...
        /// <summary>Gets or sets an integer that identifies the image from an ImageList. Stub in Modern.Forms.</summary>
        public int ImageIndex { get; set; } = -1;

        /// <summary>Gets or sets the image scaling size. Stub in Modern.Forms.</summary>
        public System.Drawing.Size ImageScaling { get; set; } = new System.Drawing.Size (16, 16);

        /// <summary>Gets or sets whether the item auto-sizes itself. Stub in Modern.Forms.</summary>
        public bool AutoSize { get; set; } = true;

        /// <summary>Gets or sets the overflow behavior. Stub in Modern.Forms.</summary>
        public ToolStripItemOverflow Overflow { get; set; } = ToolStripItemOverflow.AsNeeded;

        /// <summary>Gets or sets the text align within the item. Stub in Modern.Forms.</summary>
        public ContentAlignment TextAlign { get; set; } = ContentAlignment.MiddleCenter;

        /// <summary>Gets or sets the right-to-left mode. Stub in Modern.Forms.</summary>
        public RightToLeft RightToLeft { get; set; } = RightToLeft.No;

        /// <summary>Gets or sets the foreground color of this item. Stub in Modern.Forms.</summary>
        public System.Drawing.Color ForeColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the background color of this item. Stub in Modern.Forms.</summary>
        public System.Drawing.Color BackColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the font for this item. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Font? Font { get; set; }

        /// <summary>Gets or sets the image list key for this item. Stub in Modern.Forms.</summary>
        public string ImageKey { get; set; } = string.Empty;

        /// <summary>Gets the owner ToolStrip. Stub in Modern.Forms.</summary>
        public ToolStrip? Owner => ParentControl as ToolStrip;

        /// <summary>Gets the owner item (parent ToolStripItem). Stub in Modern.Forms.</summary>
        ...
        /// <summary>Gets or sets whether this item is selected. Stub in Modern.Forms.</summary>
    ...
    public class ToolStripButton : ToolStripItem
    {
        ...
        /// <summary>Initializes a new instance of the ToolStripButton class with text, a Modern.Drawing.Image, and click handler.</summary>
#pragma warning disable CA1416
        public ToolStripButton (string text, Modern.Drawing.Image? image, EventHandler<MouseEventArgs>? onClick = null)
...
#pragma warning restore CA1416
    ...
    public class ToolStripLabel : ToolStripItem
    {
        ...
        /// <summary>Gets or sets a value indicating whether the label acts as a hyperlink. Stub in Modern.Forms.</summary>
        public bool IsLink { get; set; }

        /// <summary>Gets or sets the link behavior. Stub in Modern.Forms.</summary>
        public LinkBehavior LinkBehavior { get; set; } = LinkBehavior.SystemDefault;

        /// <summary>Gets or sets the color used when displaying a normal link. Stub in Modern.Forms.</summary>
        public System.Drawing.Color LinkColor { get; set; } = System.Drawing.Color.Blue;

        /// <summary>Gets or sets the color used when displaying a visited link. Stub in Modern.Forms.</summary>
        public System.Drawing.Color VisitedLinkColor { get; set; } = System.Drawing.Color.Purple;

        /// <summary>Gets or sets a value indicating whether the link has been visited. Stub in Modern.Forms.</summary>
    ...
    public class ToolStripTextBox : ToolStripItem
    {
        ...
        /// <summary>Gets a reference to the underlying TextBox. Stub returns a detached TextBox in Modern.Forms.</summary>
        public TextBox TextBox { get; } = new TextBox ();

        /// <summary>Gets or sets a value indicating whether pressing Enter in the text box creates a new line. Stub in Modern.Forms.</summary>
        public bool AcceptsReturn { get; set; }

        /// <summary>Gets or sets a value indicating whether pressing Tab moves focus or inserts a tab character. Stub in Modern.Forms.</summary>
        public bool AcceptsTab { get; set; }

        /// <summary>Gets or sets the maximum number of characters that can be entered. Stub in Modern.Forms.</summary>
        public int MaxLength { get; set; } = 32767;

        /// <summary>Gets or sets a value indicating whether the text in the text box is read-only. Stub in Modern.Forms.</summary>
        public bool ReadOnly { get; set; }
    }

    /// <summary>Hosts an arbitrary Control inside a ToolStrip. Stub in Modern.Forms.</summary>
    public class ToolStripControlHost : ToolStripItem
    {
        ...
        /// <summary>Raised when the hosted control's content changes. Stub in Modern.Forms.</summary>
        public event EventHandler? ContentChanged { add { } remove { } }

        /// <summary>Raised when the hosted control receives focus. Stub in Modern.Forms.</summary>
        public new event EventHandler? GotFocus { add { } remove { } }

        /// <summary>Raised when the hosted control loses focus. Stub in Modern.Forms.</summary>
        public new event EventHandler? LostFocus { add { } remove { } }

        /// <summary>Raised when a key is pressed while focus is on the hosted control. Stub in Modern.Forms.</summary>
        public new event EventHandler<KeyEventArgs>? KeyDown { add { } remove { } }

        /// <summary>Raised when a key is released while focus is on the hosted control. Stub in Modern.Forms.</summary>
        public new event EventHandler<KeyEventArgs>? KeyUp { add { } remove { } }
    }

    /// <summary>Represents a ToolStrip-hosted drop-down control. Stub in Modern.Forms.</summary>
    ...
    public class ToolStripDropDownButton : ToolStripItem
    {
        ...
        /// <summary>Programmatically opens the drop-down. Stub in Modern.Forms.</summary>
        public new void ShowDropDown () { }

        /// <summary>Raised before the drop-down is opened. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownOpening { add { } remove { } }

        /// <summary>Raised after the drop-down is opened. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownOpened { add { } remove { } }

        /// <summary>Raised after the drop-down is closed. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownClosed { add { } remove { } }
    }

    /// <summary>Represents a button with both a clickable portion and a drop-down arrow. Stub in Modern.Forms.</summary>
    public class ToolStripSplitButton : ToolStripDropDownButton
    {
        ...
        public ToolStripSplitButton (string text, Modern.Drawing.Image? image) { Text = text; Image = image; }

        /// <summary>Gets or sets the default item clicked when the button portion is clicked. Stub in Modern.Forms.</summary>
        public ToolStripItem? DefaultItem { get; set; }

        /// <summary>Gets the width of the drop-down button portion. Stub in Modern.Forms.</summary>
        public int DropDownButtonWidth { get; set; } = 11;

        /// <summary>Raised when the button portion of the item is clicked. Stub in Modern.Forms.</summary>
        public event EventHandler? ButtonClick { add { } remove { } }

        /// <summary>Raised when the button portion of the item is double-clicked. Stub in Modern.Forms.</summary>
    ...
    public class ToolStripMenuItem : ToolStripItem
    {
        ...
        /// <summary>Initializes a new instance with text, a Modern.Drawing.Image, and click handler.</summary>
#pragma warning disable CA1416
        public ToolStripMenuItem (string text, Modern.Drawing.Image? image, EventHandler<MouseEventArgs>? onClick = null)
        {
            Text = text;
            Image = image;
        ...
        /// <summary>Initializes a new instance with text, a Modern.Drawing.Image, click handler, and subitems.</summary>
        public ToolStripMenuItem (string text, Modern.Drawing.Image? image, EventHandler<MouseEventArgs>? onClick, params ToolStripMenuItem[] dropDownItems)
            : this (text, image?.ToSKBitmap (), onClick)
        {
        ...
        /// <summary>Initializes a new instance with text, a Modern.Drawing.Image, and subitems.</summary>
        public ToolStripMenuItem (string text, Modern.Drawing.Image? image, params ToolStripMenuItem[] dropDownItems)
...
#pragma warning restore CA1416
        ...
        /// <summary>Gets or sets the shortcut key combination for this item. Stub in Modern.Forms.</summary>
        public Keys ShortcutKeys { get; set; } = Keys.None;

        /// <summary>Gets or sets the string to display for the shortcut key. Stub in Modern.Forms.</summary>
        public string ShortcutKeyDisplayString { get; set; } = string.Empty;

        /// <summary>Gets or sets whether the shortcut key is shown in the menu item. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Gets or sets the check state of the item. Stub in Modern.Forms.</summary>
        public CheckState CheckState {
            get => Checked ? CheckState.Checked : CheckState.Unchecked;
            set => Checked = value == CheckState.Checked;
        }

        /// <summary>Raised when the drop-down is about to open. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownOpening { add { } remove { } }

        /// <summary>Raised when the drop-down has been opened. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownOpened { add { } remove { } }

        /// <summary>Raised when the drop-down has been closed. Stub in Modern.Forms.</summary>
        public event EventHandler? DropDownClosed { add { } remove { } }

        /// <summary>Raised when the Checked property changes. Stub in Modern.Forms.</summary>
        public event EventHandler? CheckedChanged { add { } remove { } }

        /// <summary>Gets or sets how this item behaves when toolstrips are merged. Stub in Modern.Forms.</summary>
        public MergeAction MergeAction { get; set; } = MergeAction.Append;

        /// <summary>Gets or sets the merge index for this item. Stub in Modern.Forms.</summary>
    ...
    public class ToolStripStatusLabel : ToolStripItem
    {
        ...
        /// <summary>Gets or sets the border style of the label. Stub in Modern.Forms.</summary>
        public Border3DStyle BorderStyle { get; set; } = Border3DStyle.None;

        /// <summary>Gets or sets which sides of the label show a border. Stub in Modern.Forms.</summary>
    ...
    {
        /// <summary>Gets or sets the ToolStripMenuItem for the MDI window list. Stub in Modern.Forms.</summary>
    ...
    /// Maps to Modern.Forms' ToolBar (MenuBase) with a ToolStripItemCollection facade.
    /// </summary>
    public class ToolStrip : ToolBar
    {
        ...
        /// <summary>Gets or sets whether the ToolStrip can be moved. Stub in Modern.Forms.</summary>
        public bool GripVisible { get; set; } = true;

        /// <summary>Gets or sets the grip style for the ToolStrip. Stub in Modern.Forms.</summary>
        public ToolStripGripStyle GripStyle { get; set; } = ToolStripGripStyle.Visible;

        /// <summary>Gets or sets the text direction for the ToolStrip. Stub in Modern.Forms.</summary>
        public ToolStripTextDirection TextDirection { get; set; } = ToolStripTextDirection.Horizontal;

        /// <summary>Gets or sets the image scaling size for the ToolStrip. Stub in Modern.Forms.</summary>
        public System.Drawing.Size ImageScalingSize { get; set; } = new System.Drawing.Size (16, 16);

        /// <summary>Gets or sets whether the ToolStrip renders in a specific style. Stub in Modern.Forms.</summary>
        public bool ShowItemToolTips { get; set; } = true;

        /// <summary>Gets or sets the rendering mode for the ToolStrip. Stub in Modern.Forms.</summary>
        public ToolStripRenderMode RenderMode { get; set; } = ToolStripRenderMode.ManagerRenderMode;

        /// <summary>Gets or sets the renderer for the ToolStrip. Stub in Modern.Forms.</summary>
        public ToolStripRenderer? Renderer { get; set; }

        /// <summary>Gets or sets whether items can overflow to a dropdown. Stub in Modern.Forms.</summary>
        public bool CanOverflow { get; set; } = true;

        /// <summary>Gets or sets the layout style. Stub in Modern.Forms.</summary>
        public ToolStripLayoutStyle LayoutStyle { get; set; } = ToolStripLayoutStyle.HorizontalStackWithOverflow;

        /// <summary>Gets or sets the ImageList associated with this ToolStrip. Stub in Modern.Forms.</summary>
        public new ImageList? ImageList { get; set; }

        /// <summary>Gets or sets whether the ToolStrip stretches to fill its container. Stub in Modern.Forms.</summary>
        public bool Stretch { get; set; }
    }

    /// <summary>Represents a panel that can host ToolStrip controls. Stub in Modern.Forms.</summary>
    public class ToolStripPanel : Panel
    {
        /// <summary>Gets or sets whether the panel is locked. Stub in Modern.Forms.</summary>
        public bool Locked { get; set; }

        /// <summary>Gets or sets the orientation of the ToolStripPanel. Stub in Modern.Forms.</summary>
        public Orientation Orientation { get; set; } = Orientation.Horizontal;
    }

    /// <summary>Represents the overflow button on a ToolStrip. Stub in Modern.Forms.</summary>
    ...
    /// <summary>
    /// Stub container for dockable toolbars. In Modern.Forms, toolbars are not dockable;
    ...
    /// <summary>Provides navigation UI for a BindingSource. Stub in Modern.Forms.</summary>
    public class BindingNavigator : ToolStrip
    {
        ...
        /// <summary>Gets or sets the BindingSource this navigator is bound to. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Represents a control that allows the user to select a string from a collection by scrolling. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Provides a base class for rendering ToolStrip controls. Stub in Modern.Forms.</summary>
    public abstract class ToolStripRenderer
    {
    }

    /// <summary>Provides a professional-style renderer for ToolStrip. Stub in Modern.Forms.</summary>
    public class ToolStripProfessionalRenderer : ToolStripRenderer
    {
        /// <summary>Initializes a new instance.</summary>
        public ToolStripProfessionalRenderer () { }

        /// <summary>Gets or sets whether rounded borders are used. Stub in Modern.Forms.</summary>
        public bool RoundedEdges { get; set; } = true;
    }

    /// <summary>Provides a system-style renderer for ToolStrip. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Provides global settings for all ToolStrip controls. Stub in Modern.Forms.</summary>
    public static class ToolStripManager
    {
        /// <summary>Gets or sets the global render mode for ToolStrip controls. Stub in Modern.Forms.</summary>
        public static ToolStripRenderMode RenderMode { get; set; } = ToolStripRenderMode.Professional;

        /// <summary>Gets or sets the global renderer for ToolStrip controls. Stub in Modern.Forms.</summary>
        public static ToolStripRenderer? Renderer { get; set; }

        /// <summary>Merges the source toolstrip into the target toolstrip. Stub in Modern.Forms.</summary>
        public static bool Merge (ToolStrip sourceToolStrip, ToolStrip targetToolStrip) => false;

        /// <summary>Merges the source toolstrip into the named target. Stub in Modern.Forms.</summary>
        public static bool Merge (ToolStrip sourceToolStrip, string targetName) => false;

        /// <summary>Reverts a previous merge on the target toolstrip. Stub in Modern.Forms.</summary>
        public static bool RevertMerge (ToolStrip targetToolStrip) => false;

        /// <summary>Reverts a previous merge on the named target. Stub in Modern.Forms.</summary>
    ...
    /// <summary>WinForms compatibility: provides access to a Win32 HWND. Stub in Modern.Forms.</summary>
    public interface IWin32Window
    {
        /// <summary>Gets the Win32 handle. Always IntPtr.Zero in Modern.Forms.</summary>
        IntPtr Handle { get; }
    }

    /// <summary>WinForms compatibility: contains environment and resource information. Stub in Modern.Forms.</summary>
    public static class NativeMethods
    {
        /// <summary>Stub — Modern.Forms has no Win32 HWND; always returns 0.</summary>
        public static nint SendMessage (nint hWnd, int msg, nint wParam, nint lParam) => 0;

        /// <summary>Stub — Modern.Forms has no Win32 HWND; always returns false.</summary>
    ...
    {
        /// <summary>Gets or sets the border color of the button. Stub in Modern.Forms.</summary>
        public System.Drawing.Color BorderColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the border size. Stub in Modern.Forms.</summary>
        public int BorderSize { get; set; } = 1;

        /// <summary>Gets or sets the background color when the mouse button is held down. Stub in Modern.Forms.</summary>
        public System.Drawing.Color MouseDownBackColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the background color when the mouse is over the button. Stub in Modern.Forms.</summary>
        public System.Drawing.Color MouseOverBackColor { get; set; } = System.Drawing.Color.Empty;

        /// <summary>Gets or sets the background color when the button is checked. Stub in Modern.Forms.</summary>
...
#pragma warning disable CA1416
        ...
        public DrawItemEventArgs (SkiaSharp.SKCanvas canvas, System.Drawing.Rectangle bounds, int index, DrawItemState state)
        {
            ...
            Index = index;
            State = state;
            Font = Modern.Forms.SystemFonts.DefaultFont ?? Modern.Forms.SystemFonts.SmallCaptionFont ?? new Modern.Drawing.Font ("Arial", 9);
            ForeColor = Modern.Forms.SystemColors.WindowText;
            BackColor = (state & DrawItemState.Selected) != 0 ? Modern.Forms.SystemColors.Highlight : Modern.Forms.SystemColors.Window;
        }
#pragma warning restore CA1416
        ...
        public Modern.Drawing.Font Font { get; }
        ...
        {
#pragma warning disable CA1416
            using var brush = new Modern.Drawing.SolidBrush (BackColor);
#pragma warning restore CA1416
    ...
    /// All methods are stubs in Modern.Forms.
    /// </summary>
    public static class SendKeys
    {
        /// <summary>Sends keystrokes to the active application. Stub in Modern.Forms.</summary>
        public static void Send (string keys) { }

        /// <summary>Sends keystrokes to the active application and waits for processing. Stub in Modern.Forms.</summary>
        public static void SendWait (string keys) { }

        /// <summary>Flushes the SendKeys buffer. Stub in Modern.Forms.</summary>
    ...
    public class BindingCompleteEventArgs : System.ComponentModel.CancelEventArgs
    {
        ...
        /// <summary>Gets or sets the error text. Stub in Modern.Forms.</summary>
        public string ErrorText { get; set; } = string.Empty;

        /// <summary>Gets or sets the exception. Stub in Modern.Forms.</summary>
    ...
    public class InputLanguageChangedEventArgs : EventArgs
    {
        ...
        /// <summary>Gets the input language. Stub in Modern.Forms.</summary>
    ...
    /// <summary>WinForms compatibility: provides help for controls on a form. Stub in Modern.Forms.</summary>
    public class HelpProvider : System.ComponentModel.Component
    {
        ...
        /// <summary>Gets or sets the path to the help file. Stub in Modern.Forms.</summary>
        ...
        /// <summary>Sets whether the help provider is enabled for the specified control. Stub in Modern.Forms.</summary>
        public void SetShowHelp (Control ctl, bool value) { }

        /// <summary>Gets whether the help provider is enabled for the specified control. Stub in Modern.Forms.</summary>
        public bool GetShowHelp (Control ctl) => true;

        /// <summary>Sets the navigator type for the specified control. Stub in Modern.Forms.</summary>
        public void SetHelpNavigator (Control ctl, HelpNavigator navigator) { }

        /// <summary>Gets or sets user-defined data associated with this component. Stub in Modern.Forms.</summary>
    ...
    /// <summary>WinForms compatibility: provides methods for sending keystrokes to an application. Stub in Modern.Forms.</summary>
    public static class Help
    {
        /// <summary>Displays the contents of a Help file. Stub in Modern.Forms.</summary>
        public static void ShowHelp (Control? parent, string? url) { }

        /// <summary>Displays a Help pop-up window. Stub in Modern.Forms.</summary>
