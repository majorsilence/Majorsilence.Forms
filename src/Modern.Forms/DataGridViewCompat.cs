...
namespace Modern.Forms
{
    ...
    public class DataGridViewCellStyle : ICloneable
    {
        ...
        /// <summary>Gets or sets the font used to display text. Stub in Modern.Forms.</summary>
...
#pragma warning restore CA1416
    ...
    /// <summary>
    /// Represents an image column in a DataGridView. Stub in Modern.Forms (images are not rendered).
    /// </summary>
    public class DataGridViewImageColumn : DataGridViewColumn
    {
        /// <summary>Gets or sets the image displayed in the column. Stub in Modern.Forms.</summary>
        public Modern.Drawing.Image? Image { get; set; }

        /// <summary>Gets or sets the description of the image. Stub in Modern.Forms.</summary>
        public string Description { get; set; } = string.Empty;
    }

    /// <summary>
    /// Represents a link column in a DataGridView. Stub in Modern.Forms.
    /// </summary>
    public class DataGridViewLinkColumn : DataGridViewColumn
    {
        /// <summary>Gets or sets the link text. Stub in Modern.Forms.</summary>
        public string Text { get; set; } = string.Empty;

        /// <summary>Gets or sets the active link color. Stub in Modern.Forms.</summary>
        public System.Drawing.Color ActiveLinkColor { get; set; } = System.Drawing.Color.Red;

        /// <summary>Gets or sets the link color. Stub in Modern.Forms.</summary>
        public System.Drawing.Color LinkColor { get; set; } = System.Drawing.Color.Blue;

        /// <summary>Gets or sets the visited link color. Stub in Modern.Forms.</summary>
        public System.Drawing.Color VisitedLinkColor { get; set; } = System.Drawing.Color.Purple;

        /// <summary>Gets or sets whether the link tracking is enabled. Stub in Modern.Forms.</summary>
        public bool TrackVisitedState { get; set; } = true;

        /// <summary>Gets or sets whether the column header text is used as link text. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Provides data for the DataGridView.RowPrePaint event. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Provides data for the DataGridView.RowPostPaint event. Stub in Modern.Forms.</summary>
...
#pragma warning restore CA1711
    ...
    /// <summary>Represents a text-box cell in a DataGridView. Stub in Modern.Forms.</summary>
    public class DataGridViewTextBoxCell : DataGridViewCell { }

    /// <summary>Represents a check-box cell in a DataGridView. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Represents a combo-box cell in a DataGridView. Stub in Modern.Forms.</summary>
    ...
    /// <summary>Represents an image cell in a DataGridView. Stub in Modern.Forms.</summary>
