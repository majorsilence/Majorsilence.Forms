...
{
    /// <summary>
    /// WinForms compatibility: provides system color constants mapped to Modern.Forms theme colors.
    ...
    /// <summary>Provides pre-created Pen objects for system colors. Stub in Modern.Forms — creates new pens each call.</summary>
    ...
    /// <summary>Provides pre-created SolidBrush objects for system colors. Stub in Modern.Forms — creates new brushes each call.</summary>
