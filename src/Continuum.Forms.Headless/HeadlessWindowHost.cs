...
namespace Continuum.Forms.Headless
{
    /// <summary>
    ...
    internal sealed class HeadlessWindowHost : IWindowBackend
    {
        ...
        // Defaults to 1.0; set the CF_HEADLESS_SCALE env var to simulate a HiDPI display (e.g. "2").
        public double Scaling =>
            double.TryParse (Environment.GetEnvironmentVariable ("CF_HEADLESS_SCALE"), out var s) && s > 0 ? s : 1.0;
