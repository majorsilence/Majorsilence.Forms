...
/// <summary>
/// Maps Avalonia 12 Key enum values to Majorsilence.Forms Keys (Windows Virtual Key codes).
...
internal static class AvaloniaKeyInterop
{
    ...
    /// <summary>
    /// Converts an Avalonia <see cref="Key"/> to a Majorsilence.Forms <see cref="Keys"/> value.
    /// </summary>
