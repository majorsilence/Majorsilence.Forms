...
#pragma warning restore CS0067
    ...
    /// <summary>Abstract base class for print controllers. Stub in Majorsilence.Forms.</summary>
    public abstract class PrintController
    {
    }

    /// <summary>Sends print jobs directly to the printer. Stub in Majorsilence.Forms — the PDF pipeline is always used.</summary>
    ...
    /// <summary>Represents a print controller that drives a PrintPreviewControl. Stub in Majorsilence.Forms.</summary>
