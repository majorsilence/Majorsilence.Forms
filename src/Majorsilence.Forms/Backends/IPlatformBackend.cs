...
{
    /// <summary>
    /// Abstraction over the host UI platform (windowing toolkit + message loop) that Majorsilence.Forms
    ...
    public interface IPlatformBackend
    {
        ...
        /// <summary>Creates a UI-thread timer (used by <see cref="Majorsilence.Forms.Timer"/>).</summary>
